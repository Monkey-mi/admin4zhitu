...
public class ZTWorldLevelDto implements Serializable{

	private static final long serialVersionUID = 5369292235046475724L;
	private Integer id;
	...
	public ZTWorldLevelDto(){
		super();
	}
	
	public ZTWorldLevelDto(Integer id,
			Integer min_fans_count,Integer max_fans_count,

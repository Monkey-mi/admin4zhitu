...
public class OpNearAction extends BaseCRUDAction{
	...
	public String batchDeleteNearWorld(){
		try{
			nearService.batchDeleteNearWorld(idsStr);
			JSONUtil.optSuccess(OptResult.DELETE_SUCCESS,jsonMap);
		}catch(Exception e){
			JSONUtil.optFailed(e.getMessage(), jsonMap);
		}
	...
	public String batchInsertNearWorldFromLast(){
		try{
			nearService.batchInsertNearWorldFromLast(idsStr);
			JSONUtil.optSuccess(OptResult.ADD_SUCCESS,jsonMap);
		}catch(Exception e){
			JSONUtil.optFailed(e.getMessage(), jsonMap);
		}

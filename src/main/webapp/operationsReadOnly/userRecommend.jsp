...
var maxId = 0,
	...
	columnsFields = [
		...
		sexColumn,
		userLabelColumn,
		{field : 'concernCount',title : '关注',align : 'center',width : 60},
		{field : 'followCount',title : '关注',align : 'center',width : 60},
...
<body>
	...
	<div id="tb" style="padding:5px;height:auto" class="none">
		<div>
			...
			<select id="ss-sysAccept" class="easyui-combobox" style="width:100px;">
		        <option value="">所有系统状态</option>
		        <option value="0">待定</option>
		        <option value="1">通过</option>
		        <option value="2">拒绝</option>
	   		</select>
	   		<select id="ss-userAccept" class="easyui-combobox" style="width:100px;">
	   		...
	   		<div style="display: inline-block; vertical-align:middle; float: right;">
		        <input id="ss-userName" class="easyui-searchbox" searcher="searchByName" prompt="请输入昵称搜索用户" style="width:150px;" />
			</div>
   		</div>
	</div> 

...
<script type="text/javascript">
	...
	var columnsFields = [
             ...
             {field: "address",title: "城市数量",align: "center"}
	    ];
		...
		if(rows.length > 0){
			$.messager.confirm("温馨提示", "您确定要删除已选中的城市组吗？删除后，城市与此分组的关联关系也将被删除。", function(r){
				if(r){
					...
					$.post("./admin_near/near_batchDeleteCityGroup", params, function(result){
...
<body>
	...
	<div id="main" style="display: none;">
		...
		<div id="add_cityGroup_window">
			<form id="add_cityGroup_form" action="./admin_near/near_addCityGroup" method="post">

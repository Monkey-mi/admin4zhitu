...
<script type="text/javascript">
	var maxId=0,
	loadDateUrl="./admin_op/chuser_queryChannelUserForList",
	delUrl="./admin_op/chuser_deleteChannelUserByIds?userIds=",
	tableQueryParams = {},
	tableInit = function() {
		tableLoadDate(1);
	};
		...
		$("#htm_table").datagrid(
				{
					...
					columns: [[
						...
						{field : 'channelId',title: '频道ID',align : 'center',width : 90},
						...
						{field : 'valid',title : '有效性',align : 'center', width: 45,
				  		...
				  		{field : 'registerDate', title:'用户注册时间',align : 'center' ,width : 130,
							formatter:function(value,row,index){
								return baseTools.parseDate(value).format("yyyy/MM/dd hh:mm:ss");
							}
						},
						{field : 'lastWorldDate', title:'最后发图时间',align : 'center' ,width : 130,
							formatter:function(value,row,index){
								return baseTools.parseDate(value).format("yyyy/MM/dd hh:mm:ss");
							}
						},
						...
						{field : 'operatorName',title: '最后操作者',align : 'center',width : 90}
	...
	$(function(){
		tableInit();
		$("#channelIdSelect").combobox({
			valueField:'id',
			textField:'channelName',
			selectOnNavigation:false,
			url:'./admin_op/channel_queryAllChannel',
			onSelect:function(record){
				tableQueryParams.channelId=record.id;

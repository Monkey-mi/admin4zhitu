...
var refreshTitleInterval = 3*24*60*60*1000,
	...
	onAfterInit = function() {
		...
		$('#ss-period').combobox({
		    ...
		    textField : 'text',
		    valueField : 'period',
		    url : './admin_op/channel_queryTopOnePeriod?addAllTag=true&limit=30',
		});
...
function searchTopOne() {
	...
	myQueryParams['topOne.period'] = $('#ss-period').combobox('getValue');
...
<body>
	...
	<div id="tb" style="padding:5px;height:auto" class="none">
		<div>
			<a href="javascript:void(0);" onclick="javascript:initEditWindow(0,0,false);" class="easyui-linkbutton" title="添加频道红人" plain="true" iconCls="icon-add">添加</a>
			...
			<select id="ss-notified" class="easyui-combobox" style="width:100px;">
	   		...
	   		<input id="ss-period" style="width:100px;" />
	   		...
	   		<span style="display: inline-block; vertical-align:middle; float: right;">
		        <input id="ss-userId" class="easyui-searchbox" searcher="searchByUID" prompt="输入用户ID搜索" style="width:120px;" />
			</span>

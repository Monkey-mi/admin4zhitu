...
<head>
	...
	<link rel="stylesheet" href="/admin/base/js/jquery/qiniu/demo/bootstrap/css/bootstrap.css">
	<link rel="stylesheet" href="/admin/base/js/jquery/qiniu/demo/main.css">
	<link rel="stylesheet" href="/admin/base/js/jquery/qiniu/demo/js/highlight/highlight.css">
...
<script type="text/javascript" src="/admin/base/js/jquery/qiniu/demo/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="/admin/base/js/jquery/qiniu/demo/bootstrap/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/admin/base/js/jquery/qiniu/demo/js/plupload/plupload.full.min.js"></script>
<script type="text/javascript" src="/admin/base/js/jquery/qiniu/demo/js/plupload/i18n/zh_CN.js"></script>
<script type="text/javascript" src="/admin/base/js/jquery/qiniu/demo/js/ui.js"></script>
<script type="text/javascript" src="/admin/base/js/jquery/qiniu/src/qiniu.js"></script>
<script type="text/javascript" src="/admin/base/js/jquery/qiniu/demo/js/highlight/highlight.js"></script>
<script type="text/javascript" src="/admin/base/js/jquery/qiniu/demo/js/main.js"></script>
</body>
</html>

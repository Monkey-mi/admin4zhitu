...
var t=$(_44f);
var _450=["combo","combobox","combotree","combogrid","slider"];
...
_454.reset();
var t=$(_454);
var _455=["combo","combobox","combotree","combogrid","datebox","datetimebox","spinner","timespinner","numberbox","numberspinner","slider"];
...
function _457(_458){
var _459=$.data(_458,"form").options;
var form=$(_458);
...
var _45b=t.find(".validatebox-invalid");
_45b.filter(":not(:disabled):first").focus();
return _45b.length==0;
}
return true;
};
function _45c(_45d,_45e){
$(_45d).find(".validatebox-text:not(:disabled)").validatebox(_45e?"disableValidation":"enableValidation");
};
$.fn.form=function(_45f,_460){
if(typeof _45f=="string"){
return $.fn.form.methods[_45f](this,_460);
}
_45f=_45f||{};
return this.each(function(){
if(!$.data(this,"form")){
$.data(this,"form",{options:$.extend({},$.fn.form.defaults,_45f)});
}
_457(this);
});
};
$.fn.form.methods={submit:function(jq,_461){
return jq.each(function(){
_43c(this,$.extend({},$.fn.form.defaults,_461||{}));
});
...
$.fn.form.defaults={url:null,onSubmit:function(_462){
return $(this).form("validate");
},success:function(data){
},onBeforeLoad:function(_463){
...
(function($){
function init(_464){
$(_464).addClass("numberbox-f");
var v=$("<input type=\"hidden\">").insertAfter(_464);
var name=$(_464).attr("name");
if(name){
v.attr("name",name);
$(_464).removeAttr("name").attr("numberboxName",name);
}
return v;
};
function _465(_466){
...
_467(_466,opts.parser.call(_466,opts.value));
opts.onChange=fn;
opts.originalValue=_468(_466);
};
function _468(_469){
return $.data(_469,"numberbox").field.val();
};
function _467(_46a,_46b){
var _46c=$.data(_46a,"numberbox");
var opts=_46c.options;
var _46d=_468(_46a);
_46b=opts.parser.call(_46a,_46b);
opts.value=_46b;
_46c.field.val(_46b);
$(_46a).val(opts.formatter.call(_46a,_46b));
if(_46d!=_46b){
opts.onChange.call(_46a,_46b,_46d);
}
};
function _46e(_46f){
var opts=$.data(_46f,"numberbox").options;
$(_46f).unbind(".numberbox").bind("keypress.numberbox",function(e){
return opts.filter.call(_46f,e);
}).bind("blur.numberbox",function(){
_467(_46f,$(this).val());
$(this).val(opts.formatter.call(_46f,_468(_46f)));
}).bind("focus.numberbox",function(){
var vv=_468(_46f);
if(vv!=opts.parser.call(_46f,$(this).val())){
$(this).val(opts.formatter.call(_46f,vv));
}
});
};
function _470(_471){
...
if(_474){
opts.disabled=true;
$(_473).attr("disabled",true);
}else{
opts.disabled=false;
$(_473).removeAttr("disabled");
}
};
$.fn.numberbox=function(_475,_476){
if(typeof _475=="string"){
var _477=$.fn.numberbox.methods[_475];
if(_477){
return _477(this,_476);
}else{
return this.validatebox(_475,_476);
}
}
_475=_475||{};
return this.each(function(){
var _478=$.data(this,"numberbox");
if(_478){
$.extend(_478.options,_475);
}else{
_478=$.data(this,"numberbox",{options:$.extend({},$.fn.numberbox.defaults,$.fn.numberbox.parseOptions(this),_475),field:init(this)});
$(this).removeAttr("disabled");
$(this).css({imeMode:"disabled"});
}
_472(this,_478.options.disabled);
_46e(this);
_470(this);
_465(this);
});
...
$.fn.numberbox.parseOptions=function(_47b){
var t=$(_47b);
return $.extend({},$.fn.validatebox.parseOptions(_47b),$.parser.parseOptions(_47b,["decimalSeparator","groupSeparator","suffix",{min:"number",max:"number",precision:"number"}]),{prefix:(t.attr("prefix")?t.attr("prefix"):undefined),disabled:(t.attr("disabled")?true:undefined),value:(t.val()||undefined)});
};
...
var opts=$(this).numberbox("options");
var s1=_47c,s2="";
var dpos=_47c.indexOf(".");
if(dpos>=0){
s1=_47c.substring(0,dpos);
s2=_47c.substring(dpos+1,_47c.length);
}
...
var _481=t.find(".calendar-header");
t._outerWidth(opts.width);
t._outerHeight(opts.height);
t.find(".calendar-body")._outerHeight(t.height()-_481._outerHeight());
};
function init(_482){
$(_482).addClass("calendar").html("<div class=\"calendar-header\">"+"<div class=\"calendar-prevmonth\"></div>"+"<div class=\"calendar-nextmonth\"></div>"+"<div class=\"calendar-prevyear\"></div>"+"<div class=\"calendar-nextyear\"></div>"+"<div class=\"calendar-title\">"+"<span>Aprial 2010</span>"+"</div>"+"</div>"+"<div class=\"calendar-body\">"+"<div class=\"calendar-menu\">"+"<div class=\"calendar-menu-year-inner\">"+"<span class=\"calendar-menu-prev\"></span>"+"<span><input class=\"calendar-menu-year\" type=\"text\"></input></span>"+"<span class=\"calendar-menu-next\"></span>"+"</div>"+"<div class=\"calendar-menu-month-inner\">"+"</div>"+"</div>"+"</div>");
$(_482).find(".calendar-title span").hover(function(){
...
$(".calendar-prevmonth,.calendar-nextmonth,.calendar-prevyear,.calendar-nextyear",_482).hover(function(){
$(this).addClass("calendar-nav-hover");
},function(){
$(this).removeClass("calendar-nav-hover");
});
$(_482).find(".calendar-nextmonth").click(function(){
_483(_482,1);
});
$(_482).find(".calendar-prevmonth").click(function(){
_483(_482,-1);
});
$(_482).find(".calendar-nextyear").click(function(){
_486(_482,1);
});
$(_482).find(".calendar-prevyear").click(function(){
_486(_482,-1);
});
$(_482).bind("_resize",function(){
...
show(_484);
var menu=$(_484).find(".calendar-menu-month-inner");
...
opts.year+=_488;
show(_487);
var menu=$(_487).find(".calendar-menu-year");
menu.val(opts.year);
};
function _489(_48a){
var opts=$.data(_48a,"calendar").options;
$(_48a).find(".calendar-menu").show();
if($(_48a).find(".calendar-menu-month-inner").is(":empty")){
$(_48a).find(".calendar-menu-month-inner").empty();
var t=$("<table class=\"calendar-mtable\"></table>").appendTo($(_48a).find(".calendar-menu-month-inner"));
var idx=0;
for(var i=0;i<3;i++){
...
$(_48a).find(".calendar-menu-prev,.calendar-menu-next").hover(function(){
$(this).addClass("calendar-menu-hover");
},function(){
$(this).removeClass("calendar-menu-hover");
});
$(_48a).find(".calendar-menu-next").click(function(){
var y=$(_48a).find(".calendar-menu-year");
if(!isNaN(y.val())){
y.val(parseInt(y.val())+1);
_48b();
}
});
$(_48a).find(".calendar-menu-prev").click(function(){
var y=$(_48a).find(".calendar-menu-year");
if(!isNaN(y.val())){
y.val(parseInt(y.val()-1));
_48b();
...
$(_48a).find(".calendar-menu-year").keypress(function(e){
if(e.keyCode==13){
_48b(true);
}
});
$(_48a).find(".calendar-menu-month").hover(function(){
$(this).addClass("calendar-menu-hover");
},function(){
$(this).removeClass("calendar-menu-hover");
}).click(function(){
var menu=$(_48a).find(".calendar-menu");
...
var _48d=menu.find(".calendar-selected").attr("abbr");
if(!isNaN(year)){
opts.year=parseInt(year);
opts.month=parseInt(_48d);
show(_48a);
}
if(_48c){
menu.hide();
...
var body=$(_48a).find(".calendar-body");
var sele=$(_48a).find(".calendar-menu");
var _48e=sele.find(".calendar-menu-year-inner");
var _48f=sele.find(".calendar-menu-month-inner");
_48e.find("input").val(opts.year).focus();
_48f.find("td.calendar-selected").removeClass("calendar-selected");
_48f.find("td:eq("+(opts.month-1)+")").addClass("calendar-selected");
sele._outerWidth(body._outerWidth());
sele._outerHeight(body._outerHeight());
_48f._outerHeight(sele.height()-_48e._outerHeight());
};
function _490(_491,year,_492){
var opts=$.data(_491,"calendar").options;
var _493=[];
var _494=new Date(year,_492,0).getDate();
for(var i=1;i<=_494;i++){
_493.push([year,_492,i]);
}
var _495=[],week=[];
var _496=-1;
while(_493.length>0){
...
while(_497.length<7){
var _498=_497[0];
var date=new Date(_498[0],_498[1]-1,_498[2]-1);
_497.unshift([date.getFullYear(),date.getMonth()+1,date.getDate()]);
}
}else{
var _498=_497[0];
var week=[];
for(var i=1;i<=7;i++){
var date=new Date(_498[0],_498[1]-1,_498[2]-i);
week.unshift([date.getFullYear(),date.getMonth()+1,date.getDate()]);
}
_495.unshift(week);
}
var _499=_495[_495.length-1];
while(_499.length<7){
var _49a=_499[_499.length-1];
var date=new Date(_49a[0],_49a[1]-1,_49a[2]+1);
_499.push([date.getFullYear(),date.getMonth()+1,date.getDate()]);
}
if(_495.length<6){
var _49a=_499[_499.length-1];
var week=[];
...
var now=new Date();
var _49c=now.getFullYear()+","+(now.getMonth()+1)+","+now.getDate();
var _49d=opts.current?(opts.current.getFullYear()+","+(opts.current.getMonth()+1)+","+opts.current.getDate()):"";
var _49e=6-opts.firstDay;
var _49f=_49e+1;
if(_49e>=7){
_49e-=7;
}
...
$(_49b).find(".calendar-title span").html(opts.months[opts.month-1]+" "+opts.year);
var body=$(_49b).find("div.calendar-body");
...
data.push("</tr></thead>");
data.push("<tbody>");
var _4a0=_490(_49b,opts.year,opts.month);
...
var d=opts.formatter.call(_49b,day[0],day[1],day[2]);
...
$(this).addClass("calendar-selected");
var _4a1=$(this).attr("abbr").split(",");
opts.current=new Date(_4a1[0],parseInt(_4a1[1])-1,_4a1[2]);
opts.onSelect.call(_49b,opts.current);
});
};
$.fn.calendar=function(_4a2,_4a3){
if(typeof _4a2=="string"){
return $.fn.calendar.methods[_4a2](this,_4a3);
}
_4a2=_4a2||{};
return this.each(function(){
var _4a4=$.data(this,"calendar");
if(_4a4){
$.extend(_4a4.options,_4a2);
}else{
_4a4=$.data(this,"calendar",{options:$.extend({},$.fn.calendar.defaults,$.fn.calendar.parseOptions(this),_4a2)});
init(this);
}
if(_4a4.options.border==false){
...
$.fn.calendar.parseOptions=function(_4a5){
var t=$(_4a5);
return $.extend({},$.parser.parseOptions(_4a5,["width","height",{firstDay:"number",fit:"boolean",border:"boolean"}]));
};
...
(function($){
function init(_4a6){
var _4a7=$("<span class=\"spinner\">"+"<span class=\"spinner-arrow\">"+"<span class=\"spinner-arrow-up\"></span>"+"<span class=\"spinner-arrow-down\"></span>"+"</span>"+"</span>").insertAfter(_4a6);
$(_4a6).addClass("spinner-text spinner-f").prependTo(_4a7);
return _4a7;
};
function _4a8(_4a9,_4aa){
var opts=$.data(_4a9,"spinner").options;
var _4ab=$.data(_4a9,"spinner").spinner;
if(_4aa){
opts.width=_4aa;
}
var _4ac=$("<div style=\"display:none\"></div>").insertBefore(_4ab);
_4ab.appendTo("body");
if(isNaN(opts.width)){
opts.width=$(_4a9).outerWidth();
}
var _4ad=_4ab.find(".spinner-arrow");
_4ab._outerWidth(opts.width)._outerHeight(opts.height);
$(_4a9)._outerWidth(_4ab.width()-_4ad.outerWidth());
$(_4a9).css({height:_4ab.height()+"px",lineHeight:_4ab.height()+"px"});
_4ad._outerHeight(_4ab.height());
_4ad.find("span")._outerHeight(_4ad.height()/2);
_4ab.insertAfter(_4ac);
_4ac.remove();
};
function _4ae(_4af){
var opts=$.data(_4af,"spinner").options;
var _4b0=$.data(_4af,"spinner").spinner;
_4b0.find(".spinner-arrow-up,.spinner-arrow-down").unbind(".spinner");
if(!opts.disabled){
_4b0.find(".spinner-arrow-up").bind("mouseenter.spinner",function(){
$(this).addClass("spinner-arrow-hover");
}).bind("mouseleave.spinner",function(){
$(this).removeClass("spinner-arrow-hover");
}).bind("click.spinner",function(){
opts.spin.call(_4af,false);
opts.onSpinUp.call(_4af);
$(_4af).validatebox("validate");
});
_4b0.find(".spinner-arrow-down").bind("mouseenter.spinner",function(){
$(this).addClass("spinner-arrow-hover");
}).bind("mouseleave.spinner",function(){
$(this).removeClass("spinner-arrow-hover");
}).bind("click.spinner",function(){
opts.spin.call(_4af,true);
opts.onSpinDown.call(_4af);
$(_4af).validatebox("validate");
});
}
};
function _4b1(_4b2,_4b3){
var opts=$.data(_4b2,"spinner").options;
if(_4b3){
opts.disabled=true;
$(_4b2).attr("disabled",true);
}else{
opts.disabled=false;
$(_4b2).removeAttr("disabled");
}
};
$.fn.spinner=function(_4b4,_4b5){
if(typeof _4b4=="string"){
var _4b6=$.fn.spinner.methods[_4b4];
if(_4b6){
return _4b6(this,_4b5);
}else{
return this.validatebox(_4b4,_4b5);
}
}
_4b4=_4b4||{};
return this.each(function(){
var _4b7=$.data(this,"spinner");
if(_4b7){
$.extend(_4b7.options,_4b4);
}else{
_4b7=$.data(this,"spinner",{options:$.extend({},$.fn.spinner.defaults,$.fn.spinner.parseOptions(this),_4b4),spinner:init(this)});
$(this).removeAttr("disabled");
}
_4b7.options.originalValue=_4b7.options.value;
$(this).val(_4b7.options.value);
$(this).attr("readonly",!_4b7.options.editable);
_4b1(this,_4b7.options.disabled);
_4a8(this);
$(this).validatebox(_4b7.options);
_4ae(this);
});
};
...
return jq.each(function(){
var _4b8=$.data(this,"spinner").spinner;
$(this).validatebox("destroy");
_4b8.remove();
});
},resize:function(jq,_4b9){
return jq.each(function(){
_4a8(this,_4b9);
});
},enable:function(jq){
...
$.fn.spinner.parseOptions=function(_4bb){
var t=$(_4bb);
return $.extend({},$.fn.validatebox.parseOptions(_4bb),$.parser.parseOptions(_4bb,["width","height","min","max",{increment:"number",editable:"boolean"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined)});
};
...
(function($){
function _4bc(_4bd){
$(_4bd).addClass("numberspinner-f");
var opts=$.data(_4bd,"numberspinner").options;
$(_4bd).spinner(opts).numberbox(opts);
};
function _4be(_4bf,down){
var opts=$.data(_4bf,"numberspinner").options;
var v=parseFloat($(_4bf).numberbox("getValue")||opts.value)||0;
if(down==true){
v-=opts.increment;
}else{
v+=opts.increment;
}
$(_4bf).numberbox("setValue",v);
};
$.fn.numberspinner=function(_4c0,_4c1){
if(typeof _4c0=="string"){
var _4c2=$.fn.numberspinner.methods[_4c0];
if(_4c2){
return _4c2(this,_4c1);
}else{
return this.spinner(_4c0,_4c1);
}
}
_4c0=_4c0||{};
return this.each(function(){
var _4c3=$.data(this,"numberspinner");
if(_4c3){
$.extend(_4c3.options,_4c0);
}else{
$.data(this,"numberspinner",{options:$.extend({},$.fn.numberspinner.defaults,$.fn.numberspinner.parseOptions(this),_4c0)});
}
_4bc(this);
});
};
...
},setValue:function(jq,_4c4){
return jq.each(function(){
$(this).numberbox("setValue",_4c4);
});
},getValue:function(jq){
...
$.fn.numberspinner.parseOptions=function(_4c5){
return $.extend({},$.fn.spinner.parseOptions(_4c5),$.fn.numberbox.parseOptions(_4c5),{});
};
...
$(_4c7).addClass("timespinner-f");
$(_4c7).spinner(opts);
$(_4c7).unbind(".timespinner");
$(_4c7).bind("click.timespinner",function(){
var _4c8=0;
if(this.selectionStart!=null){
_4c8=this.selectionStart;
}else{
if(this.createTextRange){
var _4c9=_4c7.createTextRange();
var s=document.selection.createRange();
s.setEndPoint("StartToStart",_4c9);
_4c8=s.text.length;
}
}
if(_4c8>=0&&_4c8<=2){
...
function _4cb(_4cc){
var opts=$.data(_4cc,"timespinner").options;
var _4cd=0,end=0;
if(opts.highlight==0){
_4cd=0;
end=2;
...
if(_4cc.selectionStart!=null){
_4cc.setSelectionRange(_4cd,end);
}else{
if(_4cc.createTextRange){
var _4ce=_4cc.createTextRange();
_4ce.collapse();
_4ce.moveEnd("character",end);
_4ce.moveStart("character",_4cd);
_4ce.select();
}
}
$(_4cc).focus();
...
var vv=_4d1.split(opts.separator);
...
var _4d3=$(_4d2).val();
var time=_4cf(_4d2,_4d3);
if(!time){
opts.value="";
$(_4d2).val("");
return;
}
var _4d4=_4cf(_4d2,opts.min);
var _4d5=_4cf(_4d2,opts.max);
if(_4d4&&_4d4>time){
time=_4d4;
}
if(_4d5&&_4d5<time){
...
var tt=[_4d6(time.getHours()),_4d6(time.getMinutes())];
if(opts.showSeconds){
tt.push(_4d6(time.getSeconds()));
}
var val=tt.join(opts.separator);
opts.value=val;
$(_4d2).val(val);
function _4d6(_4d7){
return (_4d7<10?"0":"")+_4d7;
};
};
function _4d8(_4d9,down){
...
$(_4d9).val(vv.join(opts.separator));
_4ca(_4d9);
_4cb(_4d9);
};
$.fn.timespinner=function(_4da,_4db){
if(typeof _4da=="string"){
var _4dc=$.fn.timespinner.methods[_4da];
if(_4dc){
return _4dc(this,_4db);
}else{
return this.spinner(_4da,_4db);
}
}
_4da=_4da||{};
return this.each(function(){
var _4dd=$.data(this,"timespinner");
if(_4dd){
$.extend(_4dd.options,_4da);
}else{
$.data(this,"timespinner",{options:$.extend({},$.fn.timespinner.defaults,$.fn.timespinner.parseOptions(this),_4da)});
_4c6(this);
}
});
};
...
$.fn.timespinner.parseOptions=function(_4df){
return $.extend({},$.fn.spinner.parseOptions(_4df),$.parser.parseOptions(_4df,["separator",{showSeconds:"boolean",highlight:"number"}]));
};
...
function _4e5(_4e6){
var cc=_4e6||$("head");
var _4e7=$.data(cc[0],"ss");
if(!_4e7){
_4e7=$.data(cc[0],"ss",{cache:{},dirty:[]});
}
return {add:function(_4e8){
var ss=["<style type=\"text/css\">"];
for(var i=0;i<_4e8.length;i++){
_4e7.cache[_4e8[i][0]]={width:_4e8[i][1]};
}
var _4e9=0;
for(var s in _4e7.cache){
var item=_4e7.cache[s];
item.index=_4e9++;
...
},getRule:function(_4ea){
var _4eb=cc.children("style:last")[0];
var _4ec=_4eb.styleSheet?_4eb.styleSheet:(_4eb.sheet||document.styleSheets[document.styleSheets.length-1]);
var _4ed=_4ec.cssRules||_4ec.rules;
return _4ed[_4ea];
},set:function(_4ee,_4ef){
var item=_4e7.cache[_4ee];
if(item){
item.width=_4ef;
var rule=this.getRule(item.index);
if(rule){
rule.style["width"]=_4ef;
}
}
},remove:function(_4f0){
var tmp=[];
for(var s in _4e7.cache){
if(s.indexOf(_4f0)==-1){
tmp.push([s,_4e7.cache[s].width]);
}
}
_4e7.cache={};
this.add(tmp);
...
if(_4f1){
_4e7.dirty.push(_4f1);
}
},clean:function(){
for(var i=0;i<_4e7.dirty.length;i++){
this.remove(_4e7.dirty[i]);
}
_4e7.dirty=[];
}};
};
...
var _4f5=$.data(_4f3,"datagrid").panel;
if(_4f4){
if(_4f4.width){
opts.width=_4f4.width;
}
if(_4f4.height){
opts.height=_4f4.height;
}
}
if(opts.fit==true){
var p=_4f5.panel("panel").parent();
opts.width=p.width();
opts.height=p.height();
}
_4f5.panel("resize",{width:opts.width,height:opts.height});
};
function _4f6(_4f7){
var opts=$.data(_4f7,"datagrid").options;
var dc=$.data(_4f7,"datagrid").dc;
var wrap=$.data(_4f7,"datagrid").panel;
var _4f8=wrap.width();
var _4f9=wrap.height();
var view=dc.view;
var _4fa=dc.view1;
var _4fb=dc.view2;
var _4fc=_4fa.children("div.datagrid-header");
var _4fd=_4fb.children("div.datagrid-header");
var _4fe=_4fc.find("table");
var _4ff=_4fd.find("table");
view.width(_4f8);
var _500=_4fc.children("div.datagrid-header-inner").show();
_4fa.width(_500.find("table").width());
if(!opts.showHeader){
_500.hide();
}
_4fb.width(_4f8-_4fa._outerWidth());
_4fa.children("div.datagrid-header,div.datagrid-body,div.datagrid-footer").width(_4fa.width());
...
_4fe.css("height","");
_4ff.css("height","");
hh=Math.max(_4fe.height(),_4ff.height());
_4fe.height(hh);
_4ff.height(hh);
_4fc.add(_4fd)._outerHeight(hh);
if(opts.height!="auto"){
var _501=_4f9-_4fb.children("div.datagrid-header")._outerHeight()-_4fb.children("div.datagrid-footer")._outerHeight()-wrap.children("div.datagrid-toolbar")._outerHeight();
wrap.children("div.datagrid-pager").each(function(){
_501-=$(this)._outerHeight();
});
dc.body1.add(dc.body2).children("table.datagrid-btable-frozen").css({position:"absolute",top:dc.header2._outerHeight()});
var _502=dc.body2.children("table.datagrid-btable-frozen")._outerHeight();
_4fa.add(_4fb).children("div.datagrid-body").css({marginTop:_502,height:(_501-_502)});
}
view.height(_4fb.height());
};
function _503(_504,_505,_506){
var rows=$.data(_504,"datagrid").data.rows;
var opts=$.data(_504,"datagrid").options;
var dc=$.data(_504,"datagrid").dc;
if(!dc.body1.is(":empty")&&(!opts.nowrap||opts.autoRowHeight||_506)){
if(_505!=undefined){
var tr1=opts.finder.getTr(_504,_505,"body",1);
var tr2=opts.finder.getTr(_504,_505,"body",2);
_507(tr1,tr2);
}else{
var tr1=opts.finder.getTr(_504,0,"allbody",1);
var tr2=opts.finder.getTr(_504,0,"allbody",2);
_507(tr1,tr2);
if(opts.showFooter){
var tr1=opts.finder.getTr(_504,0,"allfooter",1);
var tr2=opts.finder.getTr(_504,0,"allfooter",2);
_507(tr1,tr2);
}
}
}
_4f6(_504);
if(opts.height=="auto"){
var _508=dc.body1.parent();
var _509=dc.body2;
var _50a=_50b(_509);
var _50c=_50a.height;
if(_50a.width>_509.width()){
_50c+=18;
}
_508.height(_50c);
_509.height(_50c);
...
function _507(trs1,trs2){
for(var i=0;i<trs2.length;i++){
var tr1=$(trs1[i]);
var tr2=$(trs2[i]);
tr1.css("height","");
tr2.css("height","");
var _50d=Math.max(tr1.height(),tr2.height());
tr1.css("height",_50d);
tr2.css("height",_50d);
}
};
...
if(c.is(":visible")){
_50f+=c._outerHeight();
if(_50e<c._outerWidth()){
_50e=c._outerWidth();
}
}
});
return {width:_50e,height:_50f};
};
};
function _510(_511,_512){
var _513=$.data(_511,"datagrid");
...
function _514(_515){
var _516=_515?1:2;
var tr=opts.finder.getTr(_511,_512,"body",_516);
(_515?dc.body1:dc.body2).children("table.datagrid-btable-frozen").append(tr);
};
};
...
var _51b=[];
var _51c=[];
$(_518).children("thead").each(function(){
...
opt.frozen?_51b.push(cols):_51c.push(cols);
});
});
return [_51b,_51c];
};
var _51d=$("<div class=\"datagrid-wrap\">"+"<div class=\"datagrid-view\">"+"<div class=\"datagrid-view1\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\">"+"<div class=\"datagrid-body-inner\"></div>"+"</div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"<div class=\"datagrid-view2\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\"></div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"</div>"+"</div>").insertAfter(_518);
_51d.panel({doSize:false});
_51d.panel("panel").addClass("datagrid").bind("_resize",function(e,_51e){
var opts=$.data(_518,"datagrid").options;
if(opts.fit==true||_51e){
_4f2(_518);
setTimeout(function(){
...
$(_518).hide().appendTo(_51d.children("div.datagrid-view"));
var cc=_51a();
var view=_51d.children("div.datagrid-view");
var _520=view.children("div.datagrid-view1");
var _521=view.children("div.datagrid-view2");
var _522=_51d.closest("div.datagrid-view");
if(!_522.length){
_522=view;
}
var ss=_4e5(_522);
return {panel:_51d,frozenColumns:cc[0],columns:cc[1],dc:{view:view,view1:_520,view2:_521,header1:_520.children("div.datagrid-header").children("div.datagrid-header-inner"),header2:_521.children("div.datagrid-header").children("div.datagrid-header-inner"),body1:_520.children("div.datagrid-body").children("div.datagrid-body-inner"),body2:_521.children("div.datagrid-body"),footer1:_520.children("div.datagrid-footer").children("div.datagrid-footer-inner"),footer2:_521.children("div.datagrid-footer").children("div.datagrid-footer-inner")},ss:ss};
};
function _523(_524){
var _525=$.data(_524,"datagrid");
var opts=_525.options;
var dc=_525.dc;
var _526=_525.panel;
_526.panel($.extend({},opts,{id:null,doSize:false,onResize:function(_527,_528){
setTimeout(function(){
if($.data(_524,"datagrid")){
_4f6(_524);
_54f(_524);
opts.onResize.call(_526,_527,_528);
}
},0);
},onExpand:function(){
_503(_524);
opts.onExpand.call(_526);
}}));
_525.rowIdPrefix="datagrid-row-r"+(++_4e0);
_525.cellClassPrefix="datagrid-cell-c"+_4e0;
_529(dc.header1,opts.frozenColumns,true);
_529(dc.header2,opts.columns,false);
_52a();
dc.header1.add(dc.header2).css("display",opts.showHeader?"block":"none");
dc.footer1.add(dc.footer2).css("display",opts.showFooter?"block":"none");
if(opts.toolbar){
if($.isArray(opts.toolbar)){
$("div.datagrid-toolbar",_526).remove();
var tb=$("<div class=\"datagrid-toolbar\"><table cellspacing=\"0\" cellpadding=\"0\"><tr></tr></table></div>").prependTo(_526);
var tr=tb.find("tr");
for(var i=0;i<opts.toolbar.length;i++){
var btn=opts.toolbar[i];
if(btn=="-"){
...
$(opts.toolbar).addClass("datagrid-toolbar").prependTo(_526);
$(opts.toolbar).show();
}
}else{
$("div.datagrid-toolbar",_526).remove();
}
$("div.datagrid-pager",_526).remove();
if(opts.pagination){
var _52b=$("<div class=\"datagrid-pager\"></div>");
if(opts.pagePosition=="bottom"){
_52b.appendTo(_526);
}else{
if(opts.pagePosition=="top"){
_52b.addClass("datagrid-pager-top").prependTo(_526);
}else{
var ptop=$("<div class=\"datagrid-pager datagrid-pager-top\"></div>").prependTo(_526);
_52b.appendTo(_526);
_52b=_52b.add(ptop);
}
}
_52b.pagination({total:(opts.pageNumber*opts.pageSize),pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_52c,_52d){
opts.pageNumber=_52c;
opts.pageSize=_52d;
_52b.pagination("refresh",{pageNumber:_52c,pageSize:_52d});
_586(_524);
}});
opts.pageSize=_52b.pagination("options").pageSize;
}
function _529(_52e,_52f,_530){
if(!_52f){
return;
}
$(_52e).show();
...
var _532=[];
if(opts.sortName){
_531=opts.sortName.split(",");
_532=opts.sortOrder.split(",");
}
var t=$("<table class=\"datagrid-htable\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tbody></tbody></table>").appendTo(_52e);
...
var pos=_4e1(_531,col.field);
if(pos>=0){
cell.addClass("datagrid-sort-"+_532[pos]);
}
...
col.cellClass=_525.cellClassPrefix+"-"+col.field.replace(/[\.|\s]/g,"-");
...
function _52a(){
var _533=[];
var _534=_535(_524,true).concat(_535(_524));
for(var i=0;i<_534.length;i++){
var col=_536(_524,_534[i]);
if(col&&!col.checkbox){
_533.push(["."+col.cellClass,col.boxWidth?col.boxWidth+"px":"auto"]);
}
}
_525.ss.add(_533);
_525.ss.dirty(_525.cellSelectorPrefix);
_525.cellSelectorPrefix="."+_525.cellClassPrefix;
};
};
function _537(_538){
...
var dc=_539.dc;
var _53b=dc.header1.add(dc.header2);
_53b.find("input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",function(e){
...
var _53c=_53b.find("div.datagrid-cell");
_53c.closest("td").unbind(".datagrid").bind("mouseenter.datagrid",function(){
if(_539.resizing){
return;
}
...
var _53d=$(this).attr("field");
opts.onHeaderContextMenu.call(_538,e,_53d);
});
_53c.unbind(".datagrid").bind("click.datagrid",function(e){
var p1=$(this).offset().left+5;
var p2=$(this).offset().left+$(this)._outerWidth()-5;
if(e.pageX<p2&&e.pageX>p1){
var _53e=$(this).parent().attr("field");
var col=_536(_538,_53e);
if(!col.sortable||_539.resizing){
return;
}
var _53f=[];
var _540=[];
if(opts.sortName){
_53f=opts.sortName.split(",");
_540=opts.sortOrder.split(",");
}
var pos=_4e1(_53f,_53e);
var _541=col.order||"asc";
if(pos>=0){
$(this).removeClass("datagrid-sort-asc datagrid-sort-desc");
var _542=_540[pos]=="asc"?"desc":"asc";
if(opts.multiSort&&_542==_541){
_53f.splice(pos,1);
_540.splice(pos,1);
}else{
_540[pos]=_542;
...
_53f=[_53e];
_540=[_541];
_53c.removeClass("datagrid-sort-asc datagrid-sort-desc");
}
$(this).addClass("datagrid-sort-"+_541);
}
opts.sortName=_53f.join(",");
opts.sortOrder=_540.join(",");
if(opts.remoteSort){
_586(_538);
}else{
var data=$.data(_538,"datagrid").data;
_57e(_538,data);
}
opts.onSortColumn.call(_538,opts.sortName,opts.sortOrder);
}
...
if(cond){
var _543=$(this).parent().attr("field");
var col=_536(_538,_543);
if(col.resizable==false){
return;
}
$(_538).datagrid("autoSizeColumn",_543);
col.auto=false;
}
});
var _544=opts.resizeHandle=="right"?"e":(opts.resizeHandle=="left"?"w":"e,w");
_53c.each(function(){
$(this).resizable({handles:_544,disabled:($(this).attr("resizable")?$(this).attr("resizable")=="false":false),minWidth:25,onStartResize:function(e){
_539.resizing=true;
_53b.css("cursor",$("body").css("cursor"));
if(!_539.proxy){
_539.proxy=$("<div class=\"datagrid-resize-proxy\"></div>").appendTo(dc.view);
}
_539.proxy.css({left:e.pageX-$(_53a).offset().left-1,display:"none"});
setTimeout(function(){
if(_539.proxy){
_539.proxy.show();
}
...
_539.proxy.css({left:e.pageX-$(_53a).offset().left-1,display:"block"});
return false;
},onStopResize:function(e){
_53b.css("cursor","");
$(this).css("height","");
...
_54f(_538);
opts.onResizeColumn.call(_538,_545,col.width);
setTimeout(function(){
_539.resizing=false;
},0);
}});
...
var _549=_548(tr);
opts.finder.getTr(_538,_549).removeClass("datagrid-row-over");
e.stopPropagation();
}).bind("click",function(e){
var tt=$(e.target);
...
var row=opts.finder.getRow(_538,_54a);
var td=tt.closest("td[field]",tr);
if(td.length){
var _54b=td.attr("field");
opts.onClickCell.call(_538,_54a,_54b,row[_54b]);
}
...
opts.onClickRow.call(_538,_54a,row);
}
e.stopPropagation();
}).bind("dblclick",function(e){
var tt=$(e.target);
...
var _54c=_548(tr);
var row=opts.finder.getRow(_538,_54c);
var td=tt.closest("td[field]",tr);
if(td.length){
var _54d=td.attr("field");
opts.onDblClickCell.call(_538,_54c,_54d,row[_54d]);
}
opts.onDblClickRow.call(_538,_54c,row);
e.stopPropagation();
}).bind("contextmenu",function(e){
var tr=$(e.target).closest("tr.datagrid-row");
if(!_546(tr)){
...
var _54e=_548(tr);
var row=opts.finder.getRow(_538,_54e);
opts.onRowContextMenu.call(_538,e,_54e,row);
e.stopPropagation();
});
...
var _552=dc.view2.children("div.datagrid-header");
var _553=0;
var _554;
var _555=_535(_550,false);
for(var i=0;i<_555.length;i++){
var col=_536(_550,_555[i]);
if(_556(col)){
_553+=col.width;
_554=col;
}
...
if(_554){
_557(_554,-_551.leftWidth);
}
var _558=_552.children("div.datagrid-header-inner").show();
var _559=_552.width()-_552.find("table").width()-opts.scrollbarSize+_551.leftWidth;
var rate=_559/_553;
if(!opts.showHeader){
_558.hide();
}
...
var col=_536(_550,_555[i]);
if(_556(col)){
var _55a=parseInt(col.width*rate);
_557(col,_55a);
_559-=_55a;
}
}
...
var _560=false;
var _561=_535(_55d,true).concat(_535(_55d,false));
for(var i=0;i<_561.length;i++){
var _55e=_561[i];
var col=_536(_55d,_55e);
if(col.auto){
_4f2(_55e);
_560=true;
}
}
if(_560&&opts.fitColumns){
_4f6(_55d);
_54f(_55d);
}
}
tmp.remove();
function _4f2(_562){
var _563=dc.view.find("div.datagrid-header td[field=\""+_562+"\"] div.datagrid-cell");
_563.css("width","");
var col=$(_55d).datagrid("getColumnOption",_562);
col.width=undefined;
col.boxWidth=undefined;
col.auto=true;
$(_55d).datagrid("fixColumnSize",_562);
var _564=Math.max(_565("header"),_565("allbody"),_565("allfooter"));
_563._outerWidth(_564);
col.width=_564;
col.boxWidth=parseInt(_563[0].style.width);
_563.css("width","");
$(_55d).datagrid("fixColumnSize",_562);
opts.onResizeColumn.call(_55d,_562,col.width);
function _565(type){
var _566=0;
if(type=="header"){
_566=_567(_563);
}else{
opts.finder.getTr(_55d,0,type).find("td[field=\""+_562+"\"] div.datagrid-cell").each(function(){
var w=_567($(this));
if(_566<w){
_566=w;
}
...
function _51f(_568,_569){
var _56a=$.data(_568,"datagrid");
var opts=_56a.options;
var dc=_56a.dc;
var _56b=dc.view.find("table.datagrid-btable,table.datagrid-ftable");
_56b.css("table-layout","fixed");
if(_569){
fix(_569);
}else{
var ff=_535(_568,true).concat(_535(_568,false));
for(var i=0;i<ff.length;i++){
fix(ff[i]);
}
}
_56b.css("table-layout","auto");
_56c(_568);
setTimeout(function(){
_503(_568);
_571(_568);
...
function fix(_56d){
var col=_536(_568,_56d);
if(!col.checkbox){
_56a.ss.set("."+col.cellClass,col.boxWidth?col.boxWidth+"px":"auto");
}
};
};
function _56c(_56e){
var dc=$.data(_56e,"datagrid").dc;
dc.body1.add(dc.body2).find("td.datagrid-td-merged").each(function(){
var td=$(this);
var _56f=td.attr("colspan")||1;
var _570=_536(_56e,td.attr("field")).width;
for(var i=1;i<_56f;i++){
td=td.next();
_570+=_536(_56e,td.attr("field")).width+1;
}
$(this).children("div.datagrid-cell")._outerWidth(_570);
});
};
function _571(_572){
var dc=$.data(_572,"datagrid").dc;
dc.view.find("div.datagrid-editable").each(function(){
var cell=$(this);
var _573=cell.parent().attr("field");
var col=$(_572).datagrid("getColumnOption",_573);
cell._outerWidth(col.width);
...
function _535(_577,_578){
var opts=$.data(_577,"datagrid").options;
var _579=(_578==true)?(opts.frozenColumns||[[]]):opts.columns;
if(_579.length==0){
return [];
}
var _57a=[];
...
function _57e(_57f,data){
var _580=$.data(_57f,"datagrid");
var opts=_580.options;
var dc=_580.dc;
data=opts.loadFilter.call(_57f,data);
data.total=parseInt(data.total);
_580.data=data;
if(data.footer){
_580.footer=data.footer;
}
if(!opts.remoteSort&&opts.sortName){
var _581=opts.sortName.split(",");
var _582=opts.sortOrder.split(",");
data.rows.sort(function(r1,r2){
var r=0;
for(var i=0;i<_581.length;i++){
var sn=_581[i];
var so=_582[i];
var col=_536(_57f,sn);
var _583=col.sorter||function(a,b){
return a==b?0:(a>b?1:-1);
};
r=_583(r1[sn],r2[sn])*(so=="asc"?1:-1);
if(r!=0){
return r;
}
}
...
opts.view.onBeforeRender.call(opts.view,_57f,data.rows);
}
opts.view.render.call(opts.view,_57f,dc.body2,false);
opts.view.render.call(opts.view,_57f,dc.body1,true);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_57f,dc.footer2,false);
opts.view.renderFooter.call(opts.view,_57f,dc.footer1,true);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_57f);
}
_580.ss.clean();
opts.onLoadSuccess.call(_57f,data);
var _584=$(_57f).datagrid("getPager");
if(_584.length){
var _585=_584.pagination("options");
if(_585.total!=data.total){
_584.pagination("refresh",{total:data.total});
if(opts.pageNumber!=_585.pageNumber){
opts.pageNumber=_585.pageNumber;
_586(_57f);
}
}
}
...
dc.body2.triggerHandler("scroll");
_587(_57f);
$(_57f).datagrid("autoSizeColumn");
};
function _587(_588){
var _589=$.data(_588,"datagrid");
var opts=_589.options;
if(opts.idField){
var _58a=$.data(_588,"treegrid")?true:false;
var _58b=opts.onSelect;
var _58c=opts.onCheck;
opts.onSelect=opts.onCheck=function(){
};
var rows=opts.finder.getRows(_588);
for(var i=0;i<rows.length;i++){
var row=rows[i];
var _58d=_58a?row[opts.idField]:i;
if(_58e(_589.selectedRows,row)){
_5a3(_588,_58d,true);
}
if(_58e(_589.checkedRows,row)){
_5aa(_588,_58d,true);
}
}
opts.onSelect=_58b;
...
var data=_594.data;
if(opts.idField){
return _594.selectedRows;
}else{
var rows=[];
opts.finder.getTr(_593,"","selected",2).each(function(){
rows.push(opts.finder.getRow(_593,$(this)));
});
return rows;
}
};
function _595(_596){
var _597=$.data(_596,"datagrid");
var opts=_597.options;
if(opts.idField){
return _597.checkedRows;
}else{
var rows=[];
opts.finder.getTr(_596,"","checked",2).each(function(){
rows.push(opts.finder.getRow(_596,$(this)));
});
return rows;
}
};
...
var _59c=dc.view2.children("div.datagrid-header")._outerHeight();
var _59d=dc.body2;
var _59e=_59d.outerHeight(true)-_59d.outerHeight();
var top=tr.position().top-_59c-_59e;
if(top<0){
_59d.scrollTop(_59d.scrollTop()+top);
}else{
if(top+tr._outerHeight()>_59d.height()-18){
_59d.scrollTop(_59d.scrollTop()+top+tr._outerHeight()-_59d.height()+18);
}
}
}
};
...
opts.finder.getTr(_5a0,_5a2.highlightIndex).removeClass("datagrid-row-over");
opts.finder.getTr(_5a0,_5a1).addClass("datagrid-row-over");
_5a2.highlightIndex=_5a1;
};
function _5a3(_5a4,_5a5,_5a6){
var _5a7=$.data(_5a4,"datagrid");
var dc=_5a7.dc;
var opts=_5a7.options;
var _5a8=_5a7.selectedRows;
...
if(opts.idField){
_4e4(_5a8,opts.idField,row);
}
opts.finder.getTr(_5a4,_5a5).addClass("datagrid-row-selected");
opts.onSelect.call(_5a4,_5a5,row);
_598(_5a4,_5a5);
};
...
var _5b0=$.data(_5ac,"datagrid").selectedRows;
if(!_5ae&&opts.checkOnSelect){
_5b1(_5ac,_5ad,true);
}
opts.finder.getTr(_5ac,_5ad).removeClass("datagrid-row-selected");
var row=opts.finder.getRow(_5ac,_5ad);
if(opts.idField){
_4e2(_5b0,opts.idField,row[opts.idField]);
}
opts.onUnselect.call(_5ac,_5ad,row);
};
function _5b2(_5b3,_5b4){
var _5b5=$.data(_5b3,"datagrid");
var opts=_5b5.options;
var rows=opts.finder.getRows(_5b3);
var _5b6=$.data(_5b3,"datagrid").selectedRows;
if(!_5b4&&opts.checkOnSelect){
_5b7(_5b3,true);
}
opts.finder.getTr(_5b3,"","allbody").addClass("datagrid-row-selected");
if(opts.idField){
for(var _5b8=0;_5b8<rows.length;_5b8++){
_4e4(_5b6,opts.idField,rows[_5b8]);
}
}
opts.onSelectAll.call(_5b3,rows);
};
function _5a9(_5b9,_5ba){
var _5bb=$.data(_5b9,"datagrid");
var opts=_5bb.options;
var rows=opts.finder.getRows(_5b9);
var _5bc=$.data(_5b9,"datagrid").selectedRows;
if(!_5ba&&opts.checkOnSelect){
_5bd(_5b9,true);
}
opts.finder.getTr(_5b9,"","selected").removeClass("datagrid-row-selected");
if(opts.idField){
for(var _5be=0;_5be<rows.length;_5be++){
_4e2(_5bc,opts.idField,rows[_5be][opts.idField]);
}
}
opts.onUnselectAll.call(_5b9,rows);
};
function _5aa(_5bf,_5c0,_5c1){
var _5c2=$.data(_5bf,"datagrid");
var opts=_5c2.options;
if(!_5c1&&opts.selectOnCheck){
_5a3(_5bf,_5c0,true);
}
var tr=opts.finder.getTr(_5bf,_5c0).addClass("datagrid-row-checked");
var ck=tr.find("div.datagrid-cell-check input[type=checkbox]");
ck._propAttr("checked",true);
tr=opts.finder.getTr(_5bf,"","checked",2);
if(tr.length==opts.finder.getRows(_5bf).length){
var dc=_5c2.dc;
var _5c3=dc.header1.add(dc.header2);
_5c3.find("input[type=checkbox]")._propAttr("checked",true);
}
var row=opts.finder.getRow(_5bf,_5c0);
if(opts.idField){
_4e4(_5c2.checkedRows,opts.idField,row);
}
opts.onCheck.call(_5bf,_5c0,row);
};
function _5b1(_5c4,_5c5,_5c6){
var _5c7=$.data(_5c4,"datagrid");
var opts=_5c7.options;
if(!_5c6&&opts.selectOnCheck){
_5ab(_5c4,_5c5,true);
}
var tr=opts.finder.getTr(_5c4,_5c5).removeClass("datagrid-row-checked");
var ck=tr.find("div.datagrid-cell-check input[type=checkbox]");
ck._propAttr("checked",false);
var dc=_5c7.dc;
var _5c8=dc.header1.add(dc.header2);
_5c8.find("input[type=checkbox]")._propAttr("checked",false);
var row=opts.finder.getRow(_5c4,_5c5);
if(opts.idField){
_4e2(_5c7.checkedRows,opts.idField,row[opts.idField]);
}
opts.onUncheck.call(_5c4,_5c5,row);
};
function _5b7(_5c9,_5ca){
var _5cb=$.data(_5c9,"datagrid");
var opts=_5cb.options;
var rows=opts.finder.getRows(_5c9);
if(!_5ca&&opts.selectOnCheck){
_5b2(_5c9,true);
}
var dc=_5cb.dc;
var hck=dc.header1.add(dc.header2).find("input[type=checkbox]");
var bck=opts.finder.getTr(_5c9,"","allbody").addClass("datagrid-row-checked").find("div.datagrid-cell-check input[type=checkbox]");
hck.add(bck)._propAttr("checked",true);
if(opts.idField){
for(var i=0;i<rows.length;i++){
_4e4(_5cb.checkedRows,opts.idField,rows[i]);
}
}
opts.onCheckAll.call(_5c9,rows);
};
function _5bd(_5cc,_5cd){
var _5ce=$.data(_5cc,"datagrid");
var opts=_5ce.options;
var rows=opts.finder.getRows(_5cc);
if(!_5cd&&opts.selectOnCheck){
_5a9(_5cc,true);
}
var dc=_5ce.dc;
var hck=dc.header1.add(dc.header2).find("input[type=checkbox]");
var bck=opts.finder.getTr(_5cc,"","checked").removeClass("datagrid-row-checked").find("div.datagrid-cell-check input[type=checkbox]");
hck.add(bck)._propAttr("checked",false);
if(opts.idField){
for(var i=0;i<rows.length;i++){
_4e2(_5ce.checkedRows,opts.idField,rows[i][opts.idField]);
}
}
opts.onUncheckAll.call(_5cc,rows);
};
function _5cf(_5d0,_5d1){
var opts=$.data(_5d0,"datagrid").options;
var tr=opts.finder.getTr(_5d0,_5d1);
var row=opts.finder.getRow(_5d0,_5d1);
if(tr.hasClass("datagrid-row-editing")){
return;
}
if(opts.onBeforeEdit.call(_5d0,_5d1,row)==false){
return;
}
...
var ed=$.data(this,"datagrid.editor");
ed.actions.setValue(ed.target,row[_5d3]);
});
_5d4(_5d0,_5d1);
};
function _5d5(_5d6,_5d7,_5d8){
var opts=$.data(_5d6,"datagrid").options;
var _5d9=$.data(_5d6,"datagrid").updatedRows;
var _5da=$.data(_5d6,"datagrid").insertedRows;
...
var ed=$.data(this,"datagrid.editor");
var _5de=ed.actions.getValue(ed.target);
if(row[_5dd]!=_5de){
row[_5dd]=_5de;
_5db=true;
_5dc[_5dd]=_5de;
...
_5df(_5d6,_5d7);
$(_5d6).datagrid("refreshRow",_5d7);
if(!_5d8){
opts.onAfterEdit.call(_5d6,_5d7,row,_5dc);
}else{
opts.onCancelEdit.call(_5d6,_5d7,row);
}
};
function _5e0(_5e1,_5e2){
var opts=$.data(_5e1,"datagrid").options;
var tr=opts.finder.getTr(_5e1,_5e2);
var _5e3=[];
...
var _5e7=_5e0(_5e5,_5e6.index!=undefined?_5e6.index:_5e6.id);
for(var i=0;i<_5e7.length;i++){
if(_5e7[i].field==_5e6.field){
return _5e7[i];
}
}
return null;
};
function _5d2(_5e8,_5e9){
var opts=$.data(_5e8,"datagrid").options;
var tr=opts.finder.getTr(_5e8,_5e9);
tr.children("td").each(function(){
var cell=$(this).find("div.datagrid-cell");
var _5ea=$(this).attr("field");
var col=_536(_5e8,_5ea);
if(col&&col.editor){
var _5eb,_5ec;
if(typeof col.editor=="string"){
_5eb=col.editor;
}else{
_5eb=col.editor.type;
_5ec=col.editor.options;
}
var _5ed=opts.editors[_5eb];
if(_5ed){
var _5ee=cell.html();
var _5ef=cell._outerWidth();
cell.addClass("datagrid-editable");
cell._outerWidth(_5ef);
cell.html("<table border=\"0\" cellspacing=\"0\" cellpadding=\"1\"><tr><td></td></tr></table>");
cell.children("table").bind("click dblclick contextmenu",function(e){
e.stopPropagation();
});
$.data(cell[0],"datagrid.editor",{actions:_5ed,target:_5ed.init(cell.find("td"),_5ec),field:_5ea,type:_5eb,oldHtml:_5ee});
}
}
});
_503(_5e8,_5e9,true);
};
function _5df(_5f0,_5f1){
...
function _5d4(_5f2,_5f3){
var tr=$.data(_5f2,"datagrid").options.finder.getTr(_5f2,_5f3);
if(!tr.hasClass("datagrid-row-editing")){
return true;
}
...
var _5f4=tr.find(".validatebox-invalid");
return _5f4.length==0;
};
function _5f5(_5f6,_5f7){
var _5f8=$.data(_5f6,"datagrid").insertedRows;
var _5f9=$.data(_5f6,"datagrid").deletedRows;
var _5fa=$.data(_5f6,"datagrid").updatedRows;
if(!_5f7){
var rows=[];
rows=rows.concat(_5f8);
...
var _5fe=$.data(_5fc,"datagrid");
var opts=_5fe.options;
var data=_5fe.data;
var _5ff=_5fe.insertedRows;
var _600=_5fe.deletedRows;
$(_5fc).datagrid("cancelEdit",_5fd);
var row=data.rows[_5fd];
if(_4e1(_5ff,row)>=0){
_4e2(_5ff,row);
}else{
_600.push(row);
}
_4e2(_5fe.selectedRows,opts.idField,data.rows[_5fd][opts.idField]);
_4e2(_5fe.checkedRows,opts.idField,data.rows[_5fd][opts.idField]);
opts.view.deleteRow.call(opts.view,_5fc,_5fd);
if(opts.height=="auto"){
_503(_5fc);
}
$(_5fc).datagrid("getPager").pagination("refresh",{total:data.total});
};
function _601(_602,_603){
var data=$.data(_602,"datagrid").data;
var view=$.data(_602,"datagrid").options.view;
var _604=$.data(_602,"datagrid").insertedRows;
view.insertRow.call(view,_602,_603.index,_603.row);
_604.push(_603.row);
$(_602).datagrid("getPager").pagination("refresh",{total:data.total});
};
function _605(_606,row){
var data=$.data(_606,"datagrid").data;
var view=$.data(_606,"datagrid").options.view;
var _607=$.data(_606,"datagrid").insertedRows;
view.insertRow.call(view,_606,null,row);
_607.push(row);
$(_606).datagrid("getPager").pagination("refresh",{total:data.total});
};
function _608(_609){
var _60a=$.data(_609,"datagrid");
var data=_60a.data;
var rows=data.rows;
var _60b=[];
for(var i=0;i<rows.length;i++){
_60b.push($.extend({},rows[i]));
}
_60a.originalRows=_60b;
_60a.updatedRows=[];
_60a.insertedRows=[];
_60a.deletedRows=[];
};
function _60c(_60d){
var data=$.data(_60d,"datagrid").data;
var ok=true;
...
var _611=_610.originalRows;
var _612=_610.insertedRows;
var _613=_610.deletedRows;
var _614=_610.selectedRows;
var _615=_610.checkedRows;
var data=_610.data;
function _616(a){
var ids=[];
for(var i=0;i<a.length;i++){
...
function _617(ids,_618){
for(var i=0;i<ids.length;i++){
var _619=_58f(_60f,ids[i]);
if(_619>=0){
(_618=="s"?_5a3:_5aa)(_60f,_619,true);
}
}
};
...
var _61a=_616(_614);
var _61b=_616(_615);
_614.splice(0,_614.length);
_615.splice(0,_615.length);
data.total+=_613.length-_612.length;
data.rows=_611;
_57e(_60f,data);
_617(_61a,"s");
_617(_61b,"c");
...
function _586(_61c,_61d){
var opts=$.data(_61c,"datagrid").options;
if(_61d){
opts.queryParams=_61d;
}
var _61e=$.extend({},opts.queryParams);
if(opts.pagination){
$.extend(_61e,{page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
$.extend(_61e,{sort:opts.sortName,order:opts.sortOrder});
}
if(opts.onBeforeLoad.call(_61c,_61e)==false){
return;
}
$(_61c).datagrid("loading");
setTimeout(function(){
_61f();
},0);
function _61f(){
var _620=opts.loader.call(_61c,_61e,function(data){
setTimeout(function(){
$(_61c).datagrid("loaded");
},0);
_57e(_61c,data);
setTimeout(function(){
_608(_61c);
...
opts.onLoadError.apply(_61c,arguments);
});
if(_620==false){
$(_61c).datagrid("loaded");
}
...
var opts=$.data(_622,"datagrid").options;
_623.rowspan=_623.rowspan||1;
_623.colspan=_623.colspan||1;
if(_623.rowspan==1&&_623.colspan==1){
return;
}
var tr=opts.finder.getTr(_622,(_623.index!=undefined?_623.index:_623.id));
if(!tr.length){
return;
}
var row=opts.finder.getRow(_622,tr);
var _624=row[_623.field];
var td=tr.find("td[field=\""+_623.field+"\"]");
td.attr("rowspan",_623.rowspan).attr("colspan",_623.colspan);
td.addClass("datagrid-td-merged");
for(var i=1;i<_623.colspan;i++){
td=td.next();
td.hide();
row[td.attr("field")]=_624;
}
for(var i=1;i<_623.rowspan;i++){
tr=tr.next();
if(!tr.length){
break;
}
var row=opts.finder.getRow(_622,tr);
var td=tr.find("td[field=\""+_623.field+"\"]").hide();
row[td.attr("field")]=_624;
for(var j=1;j<_623.colspan;j++){
td=td.next();
td.hide();
row[td.attr("field")]=_624;
}
...
$.fn.datagrid=function(_625,_626){
if(typeof _625=="string"){
return $.fn.datagrid.methods[_625](this,_626);
}
_625=_625||{};
return this.each(function(){
var _627=$.data(this,"datagrid");
var opts;
if(_627){
opts=$.extend(_627.options,_625);
_627.options=opts;
}else{
opts=$.extend({},$.extend({},$.fn.datagrid.defaults,{queryParams:{}}),$.fn.datagrid.parseOptions(this),_625);
$(this).css("width","").css("height","");
var _628=_517(this,opts.rownumbers);
if(!opts.columns){
opts.columns=_628.columns;
}
if(!opts.frozenColumns){
opts.frozenColumns=_628.frozenColumns;
}
opts.columns=$.extend(true,[],opts.columns);
opts.frozenColumns=$.extend(true,[],opts.frozenColumns);
opts.view=$.extend({},opts.view);
$.data(this,"datagrid",{options:opts,panel:_628.panel,dc:_628.dc,ss:_628.ss,selectedRows:[],checkedRows:[],data:{total:0,rows:[]},originalRows:[],updatedRows:[],insertedRows:[],deletedRows:[]});
}
_523(this);
if(opts.data){
_57e(this,opts.data);
...
var _629={text:{init:function(_62a,_62b){
var _62c=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_62a);
return _62c;
...
}},textarea:{init:function(_632,_633){
var _634=$("<textarea class=\"datagrid-editable-input\"></textarea>").appendTo(_632);
return _634;
...
$(_638)._outerWidth(_639);
}},checkbox:{init:function(_63a,_63b){
var _63c=$("<input type=\"checkbox\">").appendTo(_63a);
_63c.val(_63b.on);
_63c.attr("offval",_63b.off);
return _63c;
},getValue:function(_63d){
if($(_63d).is(":checked")){
return $(_63d).val();
}else{
return $(_63d).attr("offval");
}
...
$(_63e)._propAttr("checked",_640);
}},numberbox:{init:function(_641,_642){
var _643=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_641);
_643.numberbox(_642);
return _643;
},destroy:function(_644){
$(_644).numberbox("destroy");
},getValue:function(_645){
$(_645).blur();
return $(_645).numberbox("getValue");
},setValue:function(_646,_647){
$(_646).numberbox("setValue",_647);
},resize:function(_648,_649){
$(_648)._outerWidth(_649)._outerHeight(22);
}},validatebox:{init:function(_64a,_64b){
var _64c=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_64a);
_64c.validatebox(_64b);
return _64c;
},destroy:function(_64d){
$(_64d).validatebox("destroy");
},getValue:function(_64e){
return $(_64e).val();
},setValue:function(_64f,_650){
$(_64f).val(_650);
},resize:function(_651,_652){
$(_651)._outerWidth(_652)._outerHeight(22);
}},datebox:{init:function(_653,_654){
var _655=$("<input type=\"text\">").appendTo(_653);
_655.datebox(_654);
return _655;
},destroy:function(_656){
$(_656).datebox("destroy");
},getValue:function(_657){
return $(_657).datebox("getValue");
},setValue:function(_658,_659){
$(_658).datebox("setValue",_659);
},resize:function(_65a,_65b){
$(_65a).datebox("resize",_65b);
}},combobox:{init:function(_65c,_65d){
var _65e=$("<input type=\"text\">").appendTo(_65c);
_65e.combobox(_65d||{});
return _65e;
},destroy:function(_65f){
$(_65f).combobox("destroy");
},getValue:function(_660){
var opts=$(_660).combobox("options");
if(opts.multiple){
return $(_660).combobox("getValues").join(opts.separator);
}else{
return $(_660).combobox("getValue");
}
},setValue:function(_661,_662){
var opts=$(_661).combobox("options");
if(opts.multiple){
if(_662){
$(_661).combobox("setValues",_662.split(opts.separator));
}else{
$(_661).combobox("clear");
}
}else{
$(_661).combobox("setValue",_662);
}
},resize:function(_663,_664){
$(_663).combobox("resize",_664);
}},combotree:{init:function(_665,_666){
var _667=$("<input type=\"text\">").appendTo(_665);
_667.combotree(_666);
return _667;
},destroy:function(_668){
$(_668).combotree("destroy");
},getValue:function(_669){
return $(_669).combotree("getValue");
},setValue:function(_66a,_66b){
$(_66a).combotree("setValue",_66b);
},resize:function(_66c,_66d){
$(_66c).combotree("resize",_66d);
}}};
$.fn.datagrid.methods={options:function(jq){
var _66e=$.data(jq[0],"datagrid").options;
var _66f=$.data(jq[0],"datagrid").panel.panel("options");
var opts=$.extend(_66e,{width:_66f.width,height:_66f.height,closed:_66f.closed,collapsed:_66f.collapsed,minimized:_66f.minimized,maximized:_66f.maximized});
return opts;
...
},getColumnFields:function(jq,_670){
return _535(jq[0],_670);
},getColumnOption:function(jq,_671){
return _536(jq[0],_671);
},resize:function(jq,_672){
return jq.each(function(){
_4f2(this,_672);
});
},load:function(jq,_673){
return jq.each(function(){
var opts=$(this).datagrid("options");
opts.pageNumber=1;
var _674=$(this).datagrid("getPager");
_674.pagination("refresh",{pageNumber:1});
_586(this,_673);
});
},reload:function(jq,_675){
return jq.each(function(){
_586(this,_675);
});
},reloadFooter:function(jq,_676){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
var dc=$.data(this,"datagrid").dc;
if(_676){
$.data(this,"datagrid").footer=_676;
}
if(opts.showFooter){
...
if(opts.loadMsg){
var _677=$(this).datagrid("getPanel");
if(!_677.children("div.datagrid-mask").length){
$("<div class=\"datagrid-mask\" style=\"display:block\"></div>").appendTo(_677);
var msg=$("<div class=\"datagrid-mask-msg\" style=\"display:block;left:50%\"></div>").html(opts.loadMsg).appendTo(_677);
msg._outerHeight(40);
...
_678.children("div.datagrid-mask-msg").remove();
_678.children("div.datagrid-mask").remove();
});
},fitColumns:function(jq){
return jq.each(function(){
_54f(this);
});
},fixColumnSize:function(jq,_679){
return jq.each(function(){
_51f(this,_679);
});
},fixRowHeight:function(jq,_67a){
return jq.each(function(){
_503(this,_67a);
});
},freezeRow:function(jq,_67b){
return jq.each(function(){
_510(this,_67b);
});
},autoSizeColumn:function(jq,_67c){
return jq.each(function(){
_55c(this,_67c);
});
},loadData:function(jq,data){
...
return jq.each(function(){
var _67d=$.data(this,"datagrid").selectedRows;
_67d.splice(0,_67d.length);
_5a9(this);
});
},clearChecked:function(jq){
return jq.each(function(){
var _67e=$.data(this,"datagrid").checkedRows;
_67e.splice(0,_67e.length);
_5bd(this);
});
},scrollTo:function(jq,_67f){
return jq.each(function(){
_598(this,_67f);
});
},highlightRow:function(jq,_680){
return jq.each(function(){
_59f(this,_680);
_598(this,_680);
});
...
var opts=$.data(this,"datagrid").options;
if(opts.idField){
var _682=_58f(this,id);
if(_682>=0){
$(this).datagrid("selectRow",_682);
}
}
});
},unselectRow:function(jq,_683){
return jq.each(function(){
_5ab(this,_683);
});
},checkRow:function(jq,_684){
return jq.each(function(){
_5aa(this,_684);
});
},uncheckRow:function(jq,_685){
return jq.each(function(){
_5b1(this,_685);
});
...
},beginEdit:function(jq,_686){
return jq.each(function(){
_5cf(this,_686);
});
},endEdit:function(jq,_687){
return jq.each(function(){
_5d5(this,_687,false);
});
},cancelEdit:function(jq,_688){
return jq.each(function(){
_5d5(this,_688,true);
});
},getEditors:function(jq,_689){
return _5e0(jq[0],_689);
},getEditor:function(jq,_68a){
return _5e4(jq[0],_68a);
},refreshRow:function(jq,_68b){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
opts.view.refreshRow.call(opts.view,this,_68b);
});
},validateRow:function(jq,_68c){
return _5d4(jq[0],_68c);
},updateRow:function(jq,_68d){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
opts.view.updateRow.call(opts.view,this,_68d.index,_68d.row);
});
},appendRow:function(jq,row){
return jq.each(function(){
_605(this,row);
});
},insertRow:function(jq,_68e){
return jq.each(function(){
_601(this,_68e);
});
},deleteRow:function(jq,_68f){
return jq.each(function(){
_5fb(this,_68f);
});
},getChanges:function(jq,_690){
return _5f5(jq[0],_690);
...
},mergeCells:function(jq,_691){
return jq.each(function(){
_621(this,_691);
});
},showColumn:function(jq,_692){
return jq.each(function(){
var _693=$(this).datagrid("getPanel");
_693.find("td[field=\""+_692+"\"]").show();
$(this).datagrid("getColumnOption",_692).hidden=false;
$(this).datagrid("fitColumns");
});
},hideColumn:function(jq,_694){
return jq.each(function(){
var _695=$(this).datagrid("getPanel");
_695.find("td[field=\""+_694+"\"]").hide();
$(this).datagrid("getColumnOption",_694).hidden=true;
$(this).datagrid("fitColumns");
});
}};
$.fn.datagrid.parseOptions=function(_696){
var t=$(_696);
return $.extend({},$.fn.panel.parseOptions(_696),$.parser.parseOptions(_696,["url","toolbar","idField","sortName","sortOrder","pagePosition","resizeHandle",{fitColumns:"boolean",autoRowHeight:"boolean",striped:"boolean",nowrap:"boolean"},{rownumbers:"boolean",singleSelect:"boolean",checkOnSelect:"boolean",selectOnCheck:"boolean"},{pagination:"boolean",pageSize:"number",pageNumber:"number"},{multiSort:"boolean",remoteSort:"boolean",showHeader:"boolean",showFooter:"boolean"},{scrollbarSize:"number"}]),{pageList:(t.attr("pageList")?eval(t.attr("pageList")):undefined),loadMsg:(t.attr("loadMsg")!=undefined?t.attr("loadMsg"):undefined),rowStyler:(t.attr("rowStyler")?eval(t.attr("rowStyler")):undefined)});
};
$.fn.datagrid.parseData=function(_697){
var t=$(_697);
var data={total:0,rows:[]};
var _698=t.datagrid("getColumnFields",true).concat(t.datagrid("getColumnFields",false));
t.find("tbody tr").each(function(){
data.total++;
var row={};
$.extend(row,$.parser.parseOptions(this,["iconCls","state"]));
for(var i=0;i<_698.length;i++){
row[_698[i]]=$(this).find("td:eq("+i+")").html();
}
data.rows.push(row);
});
return data;
};
var _699={render:function(_69a,_69b,_69c){
var _69d=$.data(_69a,"datagrid");
var opts=_69d.options;
var rows=_69d.data.rows;
var _69e=$(_69a).datagrid("getColumnFields",_69c);
if(_69c){
if(!(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length))){
return;
}
}
var _69f=["<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var css=opts.rowStyler?opts.rowStyler.call(_69a,i,rows[i]):"";
var _6a0="";
var _6a1="";
...
var cls="class=\"datagrid-row "+(i%2&&opts.striped?"datagrid-row-alt ":" ")+_6a0+"\"";
var _6a2=_6a1?"style=\""+_6a1+"\"":"";
var _6a3=_69d.rowIdPrefix+"-"+(_69c?1:2)+"-"+i;
_69f.push("<tr id=\""+_6a3+"\" datagrid-row-index=\""+i+"\" "+cls+" "+_6a2+">");
_69f.push(this.renderRow.call(this,_69a,_69e,_69c,i,rows[i]));
_69f.push("</tr>");
}
_69f.push("</tbody></table>");
$(_69b).html(_69f.join(""));
},renderFooter:function(_6a4,_6a5,_6a6){
var opts=$.data(_6a4,"datagrid").options;
var rows=$.data(_6a4,"datagrid").footer||[];
var _6a7=$(_6a4).datagrid("getColumnFields",_6a6);
var _6a8=["<table class=\"datagrid-ftable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
_6a8.push("<tr class=\"datagrid-row\" datagrid-row-index=\""+i+"\">");
_6a8.push(this.renderRow.call(this,_6a4,_6a7,_6a6,i,rows[i]));
_6a8.push("</tr>");
}
_6a8.push("</tbody></table>");
$(_6a5).html(_6a8.join(""));
},renderRow:function(_6a9,_6aa,_6ab,_6ac,_6ad){
var opts=$.data(_6a9,"datagrid").options;
var cc=[];
if(_6ab&&opts.rownumbers){
var _6ae=_6ac+1;
if(opts.pagination){
_6ae+=(opts.pageNumber-1)*opts.pageSize;
}
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">"+_6ae+"</div></td>");
}
for(var i=0;i<_6aa.length;i++){
var _6af=_6aa[i];
var col=$(_6a9).datagrid("getColumnOption",_6af);
if(col){
var _6b0=_6ad[_6af];
var css=col.styler?(col.styler(_6b0,_6ad,_6ac)||""):"";
var _6b1="";
var _6b2="";
if(typeof css=="string"){
_6b2=css;
...
var cls=_6b1?"class=\""+_6b1+"\"":"";
var _6b3=col.hidden?"style=\"display:none;"+_6b2+"\"":(_6b2?"style=\""+_6b2+"\"":"");
cc.push("<td field=\""+_6af+"\" "+cls+" "+_6b3+">");
if(col.checkbox){
var _6b3="";
}else{
var _6b3=_6b2;
if(col.align){
_6b3+=";text-align:"+col.align+";";
}
if(!opts.nowrap){
...
cc.push(">");
if(col.checkbox){
cc.push("<input type=\"checkbox\" name=\""+_6af+"\" value=\""+(_6b0!=undefined?_6b0:"")+"\">");
}else{
if(col.formatter){
cc.push(col.formatter(_6b0,_6ad,_6ac));
}else{
cc.push(_6b0);
}
}
...
return cc.join("");
},refreshRow:function(_6b4,_6b5){
this.updateRow.call(this,_6b4,_6b5,{});
},updateRow:function(_6b6,_6b7,row){
var opts=$.data(_6b6,"datagrid").options;
var rows=$(_6b6).datagrid("getRows");
$.extend(rows[_6b7],row);
var css=opts.rowStyler?opts.rowStyler.call(_6b6,_6b7,rows[_6b7]):"";
var _6b8="";
var _6b9="";
if(typeof css=="string"){
_6b9=css;
...
var _6b8="datagrid-row "+(_6b7%2&&opts.striped?"datagrid-row-alt ":" ")+_6b8;
function _6ba(_6bb){
var _6bc=$(_6b6).datagrid("getColumnFields",_6bb);
var tr=opts.finder.getTr(_6b6,_6b7,"body",(_6bb?1:2));
var _6bd=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow.call(this,_6b6,_6bc,_6bb,_6b7,rows[_6b7]));
tr.attr("style",_6b9).attr("class",tr.hasClass("datagrid-row-selected")?_6b8+" datagrid-row-selected":_6b8);
if(_6bd){
...
$(_6b6).datagrid("fixRowHeight",_6b7);
},insertRow:function(_6be,_6bf,row){
var _6c0=$.data(_6be,"datagrid");
var opts=_6c0.options;
var dc=_6c0.dc;
var data=_6c0.data;
if(_6bf==undefined||_6bf==null){
_6bf=data.rows.length;
}
if(_6bf>data.rows.length){
_6bf=data.rows.length;
}
function _6c1(_6c2){
var _6c3=_6c2?1:2;
for(var i=data.rows.length-1;i>=_6bf;i--){
var tr=opts.finder.getTr(_6be,i,"body",_6c3);
tr.attr("datagrid-row-index",i+1);
tr.attr("id",_6c0.rowIdPrefix+"-"+_6c3+"-"+(i+1));
if(_6c2&&opts.rownumbers){
var _6c4=i+2;
if(opts.pagination){
_6c4+=(opts.pageNumber-1)*opts.pageSize;
}
tr.find("div.datagrid-cell-rownumber").html(_6c4);
}
if(opts.striped){
...
function _6c5(_6c6){
var _6c7=_6c6?1:2;
var _6c8=$(_6be).datagrid("getColumnFields",_6c6);
var _6c9=_6c0.rowIdPrefix+"-"+_6c7+"-"+_6bf;
var tr="<tr id=\""+_6c9+"\" class=\"datagrid-row\" datagrid-row-index=\""+_6bf+"\"></tr>";
if(_6bf>=data.rows.length){
if(data.rows.length){
opts.finder.getTr(_6be,"","last",_6c7).after(tr);
}else{
var cc=_6c6?dc.body1:dc.body2;
cc.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr+"</tbody></table>");
}
}else{
opts.finder.getTr(_6be,_6bf+1,"body",_6c7).before(tr);
}
};
_6c1.call(this,true);
_6c1.call(this,false);
_6c5.call(this,true);
_6c5.call(this,false);
data.total+=1;
data.rows.splice(_6bf,0,row);
this.refreshRow.call(this,_6be,_6bf);
},deleteRow:function(_6ca,_6cb){
var _6cc=$.data(_6ca,"datagrid");
var opts=_6cc.options;
var data=_6cc.data;
function _6cd(_6ce){
var _6cf=_6ce?1:2;
for(var i=_6cb+1;i<data.rows.length;i++){
var tr=opts.finder.getTr(_6ca,i,"body",_6cf);
tr.attr("datagrid-row-index",i-1);
tr.attr("id",_6cc.rowIdPrefix+"-"+_6cf+"-"+(i-1));
if(_6ce&&opts.rownumbers){
var _6d0=i;
if(opts.pagination){
_6d0+=(opts.pageNumber-1)*opts.pageSize;
}
tr.find("div.datagrid-cell-rownumber").html(_6d0);
}
if(opts.striped){
tr.removeClass("datagrid-row-alt").addClass((i-1)%2?"datagrid-row-alt":"");
}
...
opts.finder.getTr(_6ca,_6cb).remove();
_6cd.call(this,true);
_6cd.call(this,false);
data.total-=1;
data.rows.splice(_6cb,1);
},onBeforeRender:function(_6d1,rows){
},onAfterRender:function(_6d2){
var opts=$.data(_6d2,"datagrid").options;
if(opts.showFooter){
var _6d3=$(_6d2).datagrid("getPanel").find("div.datagrid-footer");
_6d3.find("div.datagrid-cell-rownumber,div.datagrid-cell-check").css("visibility","hidden");
}
}};
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_6d4,_6d5){
},loader:function(_6d6,_6d7,_6d8){
var opts=$(this).datagrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_6d6,dataType:"json",success:function(data){
_6d7(data);
},error:function(){
_6d8.apply(this,arguments);
}});
...
},editors:_629,finder:{getTr:function(_6d9,_6da,type,_6db){
type=type||"body";
_6db=_6db||0;
...
if(_6db==0){
var tr1=opts.finder.getTr(_6d9,_6da,type,1);
var tr2=opts.finder.getTr(_6d9,_6da,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+_6dc.rowIdPrefix+"-"+_6db+"-"+_6da);
if(!tr.length){
tr=(_6db==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index="+_6da+"]");
}
return tr;
}else{
if(type=="footer"){
return (_6db==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index="+_6da+"]");
}else{
if(type=="selected"){
return (_6db==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_6db==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_6db==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-checked");
}else{
if(type=="last"){
return (_6db==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index]:last");
}else{
if(type=="allbody"){
return (_6db==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index]");
}else{
if(type=="allfooter"){
return (_6db==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index]");
}
}
}
}
...
},getRow:function(_6dd,p){
var _6de=(typeof p=="object")?p.attr("datagrid-row-index"):p;
return $.data(_6dd,"datagrid").data.rows[parseInt(_6de)];
},getRows:function(_6df){
return $(_6df).datagrid("getRows");
}},view:_699,onBeforeLoad:function(_6e0){
},onLoadSuccess:function(){
},onLoadError:function(){
},onClickRow:function(_6e1,_6e2){
},onDblClickRow:function(_6e3,_6e4){
},onClickCell:function(_6e5,_6e6,_6e7){
},onDblClickCell:function(_6e8,_6e9,_6ea){
},onSortColumn:function(sort,_6eb){
},onResizeColumn:function(_6ec,_6ed){
},onSelect:function(_6ee,_6ef){
},onUnselect:function(_6f0,_6f1){
},onSelectAll:function(rows){
},onUnselectAll:function(rows){
},onCheck:function(_6f2,_6f3){
},onUncheck:function(_6f4,_6f5){
},onCheckAll:function(rows){
},onUncheckAll:function(rows){
},onBeforeEdit:function(_6f6,_6f7){
},onAfterEdit:function(_6f8,_6f9,_6fa){
},onCancelEdit:function(_6fb,_6fc){
},onHeaderContextMenu:function(e,_6fd){
},onRowContextMenu:function(e,_6fe,_6ff){
}});
})(jQuery);
(function($){
var _700;
function _701(_702){
var _703=$.data(_702,"propertygrid");
var opts=$.data(_702,"propertygrid").options;
$(_702).datagrid($.extend({},opts,{cls:"propertygrid",view:(opts.showGroup?opts.groupView:opts.view),onClickRow:function(_704,row){
if(_700!=this){
_705(_700);
_700=this;
}
if(opts.editIndex!=_704&&row.editor){
var col=$(this).datagrid("getColumnOption","value");
col.editor=row.editor;
_705(_700);
$(this).datagrid("beginEdit",_704);
$(this).datagrid("getEditors",_704)[0].target.focus();
opts.editIndex=_704;
}
opts.onClickRow.call(_702,_704,row);
},loadFilter:function(data){
_705(this);
...
var opts=$.data(_706,"propertygrid").options;
var _707=opts.editIndex;
if(_707==undefined){
return;
}
var ed=t.datagrid("getEditors",_707)[0];
if(ed){
ed.target.blur();
if(t.datagrid("validateRow",_707)){
t.datagrid("endEdit",_707);
}else{
t.datagrid("cancelEdit",_707);
}
}
opts.editIndex=undefined;
};
$.fn.propertygrid=function(_708,_709){
if(typeof _708=="string"){
var _70a=$.fn.propertygrid.methods[_708];
if(_70a){
return _70a(this,_709);
}else{
return this.datagrid(_708,_709);
}
}
_708=_708||{};
return this.each(function(){
var _70b=$.data(this,"propertygrid");
if(_70b){
$.extend(_70b.options,_708);
}else{
var opts=$.extend({},$.fn.propertygrid.defaults,$.fn.propertygrid.parseOptions(this),_708);
opts.frozenColumns=$.extend(true,[],opts.frozenColumns);
opts.columns=$.extend(true,[],opts.columns);
...
$.fn.propertygrid.parseOptions=function(_70c){
return $.extend({},$.fn.datagrid.parseOptions(_70c),$.parser.parseOptions(_70c,[{showGroup:"boolean"}]));
};
var _70d=$.extend({},$.fn.datagrid.defaults.view,{render:function(_70e,_70f,_710){
var _711=[];
var _712=this.groups;
for(var i=0;i<_712.length;i++){
_711.push(this.renderGroup.call(this,_70e,i,_712[i],_710));
}
$(_70f).html(_711.join(""));
},renderGroup:function(_713,_714,_715,_716){
var _717=$.data(_713,"datagrid");
var opts=_717.options;
var _718=$(_713).datagrid("getColumnFields",_716);
var _719=[];
_719.push("<div class=\"datagrid-group\" group-index="+_714+">");
_719.push("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"height:100%\"><tbody>");
_719.push("<tr>");
if((_716&&(opts.rownumbers||opts.frozenColumns.length))||(!_716&&!(opts.rownumbers||opts.frozenColumns.length))){
_719.push("<td style=\"border:0;text-align:center;width:25px\"><span class=\"datagrid-row-expander datagrid-row-collapse\" style=\"display:inline-block;width:16px;height:16px;cursor:pointer\">&nbsp;</span></td>");
}
_719.push("<td style=\"border:0;\">");
if(!_716){
_719.push("<span class=\"datagrid-group-title\">");
_719.push(opts.groupFormatter.call(_713,_715.value,_715.rows));
_719.push("</span>");
}
_719.push("</td>");
_719.push("</tr>");
...
_719.push("</div>");
_719.push("<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>");
var _71a=_715.startIndex;
for(var j=0;j<_715.rows.length;j++){
var css=opts.rowStyler?opts.rowStyler.call(_713,_71a,_715.rows[j]):"";
var _71b="";
var _71c="";
if(typeof css=="string"){
_71c=css;
...
var cls="class=\"datagrid-row "+(_71a%2&&opts.striped?"datagrid-row-alt ":" ")+_71b+"\"";
var _71d=_71c?"style=\""+_71c+"\"":"";
var _71e=_717.rowIdPrefix+"-"+(_716?1:2)+"-"+_71a;
_719.push("<tr id=\""+_71e+"\" datagrid-row-index=\""+_71a+"\" "+cls+" "+_71d+">");
_719.push(this.renderRow.call(this,_713,_718,_716,_71a,_715.rows[j]));
_719.push("</tr>");
_71a++;
}
_719.push("</tbody></table>");
return _719.join("");
},bindEvents:function(_71f){
var _720=$.data(_71f,"datagrid");
var dc=_720.dc;
var body=dc.body1.add(dc.body2);
var _721=($.data(body[0],"events")||$._data(body[0],"events")).click[0].handler;
body.unbind("click").bind("click",function(e){
var tt=$(e.target);
var _722=tt.closest("span.datagrid-row-expander");
if(_722.length){
var _723=_722.closest("div.datagrid-group").attr("group-index");
if(_722.hasClass("datagrid-row-collapse")){
$(_71f).datagrid("collapseGroup",_723);
}else{
$(_71f).datagrid("expandGroup",_723);
}
}else{
_721(e);
}
...
},onBeforeRender:function(_724,rows){
...
for(var i=0;i<rows.length;i++){
var row=rows[i];
var _728=_729(row[opts.groupField]);
if(!_728){
_728={value:row[opts.groupField],rows:[row]};
_727.push(_728);
}else{
_728.rows.push(row);
}
...
var _728=_727[i];
_728.startIndex=_72a;
_72a+=_728.rows.length;
_72b=_72b.concat(_728.rows);
}
_725.data.rows=_72b;
this.groups=_727;
var that=this;
setTimeout(function(){
that.bindEvents(_724);
},0);
function _729(_72c){
for(var i=0;i<_727.length;i++){
var _72d=_727[i];
...
$.extend($.fn.datagrid.methods,{expandGroup:function(jq,_72e){
return jq.each(function(){
var view=$.data(this,"datagrid").dc.view;
var _72f=view.find(_72e!=undefined?"div.datagrid-group[group-index=\""+_72e+"\"]":"div.datagrid-group");
var _730=_72f.find("span.datagrid-row-expander");
if(_730.hasClass("datagrid-row-expand")){
_730.removeClass("datagrid-row-expand").addClass("datagrid-row-collapse");
_72f.next("table").show();
}
$(this).datagrid("fixRowHeight");
});
},collapseGroup:function(jq,_731){
return jq.each(function(){
var view=$.data(this,"datagrid").dc.view;
var _732=view.find(_731!=undefined?"div.datagrid-group[group-index=\""+_731+"\"]":"div.datagrid-group");
var _733=_732.find("span.datagrid-row-expander");
if(_733.hasClass("datagrid-row-collapse")){
_733.removeClass("datagrid-row-collapse").addClass("datagrid-row-expand");
_732.next("table").hide();
}
$(this).datagrid("fixRowHeight");
});
}});
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupView:_70d,groupField:"group",groupFormatter:function(_734,rows){
return _734;
}});
})(jQuery);
(function($){
function _735(_736){
var _737=$.data(_736,"treegrid");
var opts=_737.options;
$(_736).datagrid($.extend({},opts,{url:null,data:null,loader:function(){
return false;
},onBeforeLoad:function(){
return false;
},onLoadSuccess:function(){
},onResizeColumn:function(_738,_739){
_74f(_736);
opts.onResizeColumn.call(_736,_738,_739);
},onSortColumn:function(sort,_73a){
opts.sortName=sort;
opts.sortOrder=_73a;
if(opts.remoteSort){
_74e(_736);
}else{
var data=$(_736).treegrid("getData");
_764(_736,0,data);
}
opts.onSortColumn.call(_736,sort,_73a);
},onBeforeEdit:function(_73b,row){
if(opts.onBeforeEdit.call(_736,row)==false){
return false;
}
},onAfterEdit:function(_73c,row,_73d){
opts.onAfterEdit.call(_736,row,_73d);
},onCancelEdit:function(_73e,row){
opts.onCancelEdit.call(_736,row);
},onSelect:function(_73f){
opts.onSelect.call(_736,find(_736,_73f));
},onUnselect:function(_740){
opts.onUnselect.call(_736,find(_736,_740));
},onCheck:function(_741){
opts.onCheck.call(_736,find(_736,_741));
},onUncheck:function(_742){
opts.onUncheck.call(_736,find(_736,_742));
},onClickRow:function(_743){
opts.onClickRow.call(_736,find(_736,_743));
},onDblClickRow:function(_744){
opts.onDblClickRow.call(_736,find(_736,_744));
},onClickCell:function(_745,_746){
opts.onClickCell.call(_736,_746,find(_736,_745));
},onDblClickCell:function(_747,_748){
opts.onDblClickCell.call(_736,_748,find(_736,_747));
},onRowContextMenu:function(e,_749){
opts.onContextMenu.call(_736,e,find(_736,_749));
}}));
if(!opts.columns){
var _74a=$.data(_736,"datagrid").options;
opts.columns=_74a.columns;
opts.frozenColumns=_74a.frozenColumns;
}
_737.dc=$.data(_736,"datagrid").dc;
if(opts.pagination){
var _74b=$(_736).datagrid("getPager");
_74b.pagination({pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_74c,_74d){
opts.pageNumber=_74c;
opts.pageSize=_74d;
_74e(_736);
}});
opts.pageSize=_74b.pagination("options").pageSize;
}
};
...
if(_751!=undefined){
var _752=_753(_750,_751);
for(var i=0;i<_752.length;i++){
_754(_752[i][opts.idField]);
}
}
}
$(_750).datagrid("fixRowHeight",_751);
function _754(_755){
var tr1=opts.finder.getTr(_750,_755,"body",1);
var tr2=opts.finder.getTr(_750,_755,"body",2);
tr1.css("height","");
tr2.css("height","");
var _756=Math.max(tr1.height(),tr2.height());
tr1.css("height",_756);
tr2.css("height",_756);
};
};
function _757(_758){
var dc=$.data(_758,"datagrid").dc;
...
function _759(_75a){
var dc=$.data(_75a,"datagrid").dc;
var body=dc.body1.add(dc.body2);
var _75b=($.data(body[0],"events")||$._data(body[0],"events")).click[0].handler;
...
var tr1=opts.finder.getTr(_75e,_75f,"body",1);
var tr2=opts.finder.getTr(_75e,_75f,"body",2);
var _760=$(_75e).datagrid("getColumnFields",true).length+(opts.rownumbers?1:0);
var _761=$(_75e).datagrid("getColumnFields",false).length;
_762(tr1,_760);
_762(tr2,_761);
function _762(tr,_763){
$("<tr class=\"treegrid-tr-tree\">"+"<td style=\"border:0px\" colspan=\""+_763+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
function _764(_765,_766,data,_767){
var _768=$.data(_765,"treegrid");
var opts=_768.options;
var dc=_768.dc;
data=opts.loadFilter.call(_765,data,_766);
var node=find(_765,_766);
if(node){
var _769=opts.finder.getTr(_765,_766,"body",1);
var _76a=opts.finder.getTr(_765,_766,"body",2);
var cc1=_769.next("tr.treegrid-tr-tree").children("td").children("div");
var cc2=_76a.next("tr.treegrid-tr-tree").children("td").children("div");
if(!_767){
node.children=[];
}
}else{
...
if(opts.view.onBeforeRender){
opts.view.onBeforeRender.call(opts.view,_765,_766,data);
}
opts.view.render.call(opts.view,_765,cc1,true);
opts.view.render.call(opts.view,_765,cc2,false);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_765,dc.footer1,true);
opts.view.renderFooter.call(opts.view,_765,dc.footer2,false);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_765);
}
opts.onLoadSuccess.call(_765,node,data);
if(!_766&&opts.pagination){
var _76b=$.data(_765,"treegrid").total;
var _76c=$(_765).datagrid("getPager");
if(_76c.pagination("options").total!=_76b){
_76c.pagination({total:_76b});
}
}
_74f(_765);
_757(_765);
$(_765).treegrid("setSelectionState");
$(_765).treegrid("autoSizeColumn");
};
function _74e(_76d,_76e,_76f,_770,_771){
var opts=$.data(_76d,"treegrid").options;
var body=$(_76d).datagrid("getPanel").find("div.datagrid-body");
if(_76f){
opts.queryParams=_76f;
}
var _772=$.extend({},opts.queryParams);
if(opts.pagination){
$.extend(_772,{page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
$.extend(_772,{sort:opts.sortName,order:opts.sortOrder});
}
var row=find(_76d,_76e);
if(opts.onBeforeLoad.call(_76d,row,_772)==false){
return;
}
var _773=body.find("tr[node-id=\""+_76e+"\"] span.tree-folder");
_773.addClass("tree-loading");
$(_76d).treegrid("loading");
var _774=opts.loader.call(_76d,_772,function(data){
_773.removeClass("tree-loading");
$(_76d).treegrid("loaded");
_764(_76d,_76e,data,_770);
if(_771){
_771();
}
},function(){
_773.removeClass("tree-loading");
$(_76d).treegrid("loaded");
opts.onLoadError.apply(_76d,arguments);
if(_771){
_771();
}
});
...
function _777(_778){
return $.data(_778,"treegrid").data;
};
function _779(_77a,_77b){
var row=find(_77a,_77b);
if(row._parentId){
return find(_77a,row._parentId);
}else{
return null;
}
};
function _753(_77c,_77d){
var opts=$.data(_77c,"treegrid").options;
var body=$(_77c).datagrid("getPanel").find("div.datagrid-view2 div.datagrid-body");
var _77e=[];
if(_77d){
_77f(_77d);
}else{
...
_77e.push(_780[i]);
_77f(_780[i][opts.idField]);
}
}
function _77f(_781){
var _782=find(_77c,_781);
if(_782&&_782.children){
for(var i=0,len=_782.children.length;i<len;i++){
var _783=_782.children[i];
_77e.push(_783);
_77f(_783[opts.idField]);
}
}
};
return _77e;
...
var view=$(_785).datagrid("getPanel").children("div.datagrid-view");
var node=view.find("div.datagrid-body tr[node-id=\""+_786+"\"]").children("td[field=\""+opts.treeField+"\"]");
return node.find("span.tree-indent,span.tree-hit").length;
};
function find(_787,_788){
var opts=$.data(_787,"treegrid").options;
var data=$.data(_787,"treegrid").data;
var cc=[data];
while(cc.length){
var c=cc.shift();
for(var i=0;i<c.length;i++){
var node=c[i];
if(node[opts.idField]==_788){
return node;
}else{
if(node["children"]){
...
if(opts.onBeforeCollapse.call(_78a,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
$(_78a).treegrid("autoSizeColumn");
_74f(_78a,_78b);
opts.onCollapse.call(_78a,row);
});
}else{
cc.hide();
$(_78a).treegrid("autoSizeColumn");
...
var tr=opts.finder.getTr(_78d,_78e);
var hit=tr.find("span.tree-hit");
var row=find(_78d,_78e);
if(hit.length==0){
return;
}
if(hit.hasClass("tree-expanded")){
...
if(opts.onBeforeExpand.call(_78d,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _78f=tr.next("tr.treegrid-tr-tree");
if(_78f.length){
var cc=_78f.children("td").children("div");
_790(cc);
}else{
_75d(_78d,row[opts.idField]);
var _78f=tr.next("tr.treegrid-tr-tree");
var cc=_78f.children("td").children("div");
cc.hide();
var _791=$.extend({},opts.queryParams||{});
_791.id=row[opts.idField];
_74e(_78d,row[opts.idField],_791,true,function(){
if(cc.is(":empty")){
_78f.remove();
}else{
_790(cc);
...
$(_78d).treegrid("autoSizeColumn");
_74f(_78d,_78e);
opts.onExpand.call(_78d,row);
});
}else{
cc.show();
$(_78d).treegrid("autoSizeColumn");
...
var _797=_753(_795,_796);
if(_796){
_797.unshift(find(_795,_796));
}
for(var i=0;i<_797.length;i++){
_789(_795,_797[i][opts.idField]);
}
};
function _798(_799,_79a){
var opts=$.data(_799,"treegrid").options;
var _79b=_753(_799,_79a);
if(_79a){
_79b.unshift(find(_799,_79a));
}
for(var i=0;i<_79b.length;i++){
_78c(_799,_79b[i][opts.idField]);
}
};
function _79c(_79d,_79e){
var opts=$.data(_79d,"treegrid").options;
var ids=[];
var p=_779(_79d,_79e);
while(p){
...
var opts=$.data(_7a0,"treegrid").options;
if(_7a1.parent){
var tr=opts.finder.getTr(_7a0,_7a1.parent);
if(tr.next("tr.treegrid-tr-tree").length==0){
_75d(_7a0,_7a1.parent);
}
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
var _7a2=cell.children("span.tree-icon");
if(_7a2.hasClass("tree-file")){
_7a2.removeClass("tree-file").addClass("tree-folder tree-folder-open");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_7a2);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_764(_7a0,_7a1.parent,_7a1.data,true);
};
function _7a3(_7a4,_7a5){
var ref=_7a5.before||_7a5.after;
var opts=$.data(_7a4,"treegrid").options;
var _7a6=_779(_7a4,ref);
_79f(_7a4,{parent:(_7a6?_7a6[opts.idField]:null),data:[_7a5.data]});
_7a7(true);
_7a7(false);
_757(_7a4);
function _7a7(_7a8){
var _7a9=_7a8?1:2;
var tr=opts.finder.getTr(_7a4,_7a5.data[opts.idField],"body",_7a9);
var _7aa=tr.closest("table.datagrid-btable");
tr=tr.parent().children();
var dest=opts.finder.getTr(_7a4,ref,"body",_7a9);
if(_7a5.before){
...
var _7ae=del(_7ad);
if(_7ae){
if(_7ae.children.length==0){
tr=opts.finder.getTr(_7ac,_7ae[opts.idField]);
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
...
function del(id){
var cc;
var _7af=_779(_7ac,_7ad);
if(_7af){
cc=_7af.children;
}else{
cc=$(_7ac).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
$.fn.treegrid=function(_7b0,_7b1){
if(typeof _7b0=="string"){
var _7b2=$.fn.treegrid.methods[_7b0];
if(_7b2){
...
_7b0=_7b0||{};
return this.each(function(){
var _7b3=$.data(this,"treegrid");
if(_7b3){
$.extend(_7b3.options,_7b0);
}else{
_7b3=$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_7b0),data:[]});
}
_735(this);
if(_7b3.options.data){
$(this).treegrid("loadData",_7b3.options.data);
}
_74e(this);
_759(this);
});
...
},resize:function(jq,_7b4){
return jq.each(function(){
$(this).datagrid("resize",_7b4);
});
},fixRowHeight:function(jq,_7b5){
return jq.each(function(){
_74f(this,_7b5);
});
},loadData:function(jq,data){
return jq.each(function(){
_764(this,data.parent,data);
});
},load:function(jq,_7b6){
return jq.each(function(){
$(this).treegrid("options").pageNumber=1;
$(this).treegrid("getPager").pagination({pageNumber:1});
$(this).treegrid("reload",_7b6);
});
...
_7b7=$.extend({},opts.queryParams);
_7b7.id=id;
}
if(_7b7.id){
var node=$(this).treegrid("find",_7b7.id);
if(node.children){
node.children.splice(0,node.children.length);
}
opts.queryParams=_7b7;
var tr=opts.finder.getTr(this,_7b7.id);
tr.next("tr.treegrid-tr-tree").remove();
...
},reloadFooter:function(jq,_7b8){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var dc=$.data(this,"datagrid").dc;
if(_7b8){
$.data(this,"treegrid").footer=_7b8;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,dc.footer1,true);
opts.view.renderFooter.call(opts.view,this,dc.footer2,false);
...
},append:function(jq,_7b9){
return jq.each(function(){
_79f(this,_7b9);
});
},insert:function(jq,_7ba){
return jq.each(function(){
_7a3(this,_7ba);
});
...
},update:function(jq,_7bb){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
opts.view.updateRow.call(opts.view,this,_7bb.id,_7bb.row);
});
...
$.fn.treegrid.parseOptions=function(_7bc){
return $.extend({},$.fn.datagrid.parseOptions(_7bc),$.parser.parseOptions(_7bc,["treeField",{animate:"boolean"}]));
};
var _7bd=$.extend({},$.fn.datagrid.defaults.view,{render:function(_7be,_7bf,_7c0){
var opts=$.data(_7be,"treegrid").options;
var _7c1=$(_7be).datagrid("getColumnFields",_7c0);
var _7c2=$.data(_7be,"datagrid").rowIdPrefix;
if(_7c0){
if(!(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length))){
return;
}
...
var _7c3=0;
var view=this;
var _7c4=_7c5(_7c0,this.treeLevel,this.treeNodes);
$(_7bf).append(_7c4.join(""));
function _7c5(_7c6,_7c7,_7c8){
var _7c9=["<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<_7c8.length;i++){
var row=_7c8[i];
if(row.state!="open"&&row.state!="closed"){
row.state="open";
}
var css=opts.rowStyler?opts.rowStyler.call(_7be,row):"";
var _7ca="";
var _7cb="";
if(typeof css=="string"){
_7cb=css;
...
var cls="class=\"datagrid-row "+(_7c3++%2&&opts.striped?"datagrid-row-alt ":" ")+_7ca+"\"";
var _7cc=_7cb?"style=\""+_7cb+"\"":"";
var _7cd=_7c2+"-"+(_7c6?1:2)+"-"+row[opts.idField];
_7c9.push("<tr id=\""+_7cd+"\" node-id=\""+row[opts.idField]+"\" "+cls+" "+_7cc+">");
_7c9=_7c9.concat(view.renderRow.call(view,_7be,_7c1,_7c6,_7c7,row));
_7c9.push("</tr>");
if(row.children&&row.children.length){
var tt=_7c5(_7c6,_7c7+1,row.children);
var v=row.state=="closed"?"none":"block";
_7c9.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_7c1.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_7c9=_7c9.concat(tt);
_7c9.push("</div></td></tr>");
}
}
...
},renderFooter:function(_7ce,_7cf,_7d0){
var opts=$.data(_7ce,"treegrid").options;
var rows=$.data(_7ce,"treegrid").footer||[];
var _7d1=$(_7ce).datagrid("getColumnFields",_7d0);
var _7d2=["<table class=\"datagrid-ftable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
row[opts.idField]=row[opts.idField]||("foot-row-id"+i);
_7d2.push("<tr class=\"datagrid-row\" node-id=\""+row[opts.idField]+"\">");
_7d2.push(this.renderRow.call(this,_7ce,_7d1,_7d0,0,row));
_7d2.push("</tr>");
}
_7d2.push("</tbody></table>");
$(_7cf).html(_7d2.join(""));
},renderRow:function(_7d3,_7d4,_7d5,_7d6,row){
var opts=$.data(_7d3,"treegrid").options;
var cc=[];
if(_7d5&&opts.rownumbers){
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">0</div></td>");
}
for(var i=0;i<_7d4.length;i++){
var _7d7=_7d4[i];
var col=$(_7d3).datagrid("getColumnOption",_7d7);
if(col){
var css=col.styler?(col.styler(row[_7d7],row)||""):"";
var _7d8="";
var _7d9="";
if(typeof css=="string"){
_7d9=css;
...
var cls=_7d8?"class=\""+_7d8+"\"":"";
var _7da=col.hidden?"style=\"display:none;"+_7d9+"\"":(_7d9?"style=\""+_7d9+"\"":"");
cc.push("<td field=\""+_7d7+"\" "+cls+" "+_7da+">");
if(col.checkbox){
var _7da="";
}else{
var _7da=_7d9;
if(col.align){
_7da+=";text-align:"+col.align+";";
}
if(!opts.nowrap){
_7da+=";white-space:normal;height:auto;";
}else{
if(opts.autoRowHeight){
_7da+=";height:auto;";
}
...
cc.push(" name=\""+_7d7+"\" value=\""+(row[_7d7]!=undefined?row[_7d7]:"")+"\"/>");
}else{
var val=null;
if(col.formatter){
val=col.formatter(row[_7d7],row);
}else{
val=row[_7d7];
}
if(_7d7==opts.treeField){
for(var j=0;j<_7d6;j++){
cc.push("<span class=\"tree-indent\"></span>");
}
if(row.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
...
return cc.join("");
},refreshRow:function(_7db,id){
this.updateRow.call(this,_7db,id,{});
},updateRow:function(_7dc,id,row){
var opts=$.data(_7dc,"treegrid").options;
var _7dd=$(_7dc).treegrid("find",id);
$.extend(_7dd,row);
var _7de=$(_7dc).treegrid("getLevel",id)-1;
var _7df=opts.rowStyler?opts.rowStyler.call(_7dc,_7dd):"";
function _7e0(_7e1){
var _7e2=$(_7dc).treegrid("getColumnFields",_7e1);
var tr=opts.finder.getTr(_7dc,id,"body",(_7e1?1:2));
var _7e3=tr.find("div.datagrid-cell-rownumber").html();
var _7e4=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow(_7dc,_7e2,_7e1,_7de,_7dd));
tr.attr("style",_7df||"");
tr.find("div.datagrid-cell-rownumber").html(_7e3);
if(_7e4){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
};
_7e0.call(this,true);
_7e0.call(this,false);
$(_7dc).treegrid("fixRowHeight",id);
},onBeforeRender:function(_7e5,_7e6,data){
if($.isArray(_7e6)){
data={total:_7e6.length,rows:_7e6};
_7e6=null;
}
if(!data){
return false;
}
var _7e7=$.data(_7e5,"treegrid");
...
if(data.total){
_7e7.total=data.total;
}
data=this.transfer(_7e5,_7e6,data.rows);
}else{
...
row._parentId=_7ea;
if(row.children&&row.children.length){
_7e8(row.children,row[opts.idField]);
}
}
};
_7e8(data,_7e6);
}
var node=find(_7e5,_7e6);
if(node){
if(node.children){
...
_7e7.data=_7e7.data.concat(data);
}
this.sort(_7e5,data);
this.treeNodes=data;
this.treeLevel=$(_7e5).treegrid("getLevel",_7e6);
},sort:function(_7eb,data){
...
var sn=_7ec[i];
var so=_7ed[i];
var col=$(_7eb).treegrid("getColumnOption",sn);
var _7ef=col.sorter||function(a,b){
return a==b?0:(a>b?1:-1);
};
r=_7ef(r1[sn],r2[sn])*(so=="asc"?1:-1);
if(r!=0){
return r;
}
}
...
for(var i=0;i<rows.length;i++){
var _7f0=rows[i].children;
if(_7f0&&_7f0.length){
_7ee(_7f0);
}
}
};
},transfer:function(_7f1,_7f2,data){
...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,animate:false,singleSelect:true,view:_7bd,loader:function(_7f4,_7f5,_7f6){
var opts=$(this).treegrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_7f4,dataType:"json",success:function(data){
_7f5(data);
},error:function(){
_7f6.apply(this,arguments);
}});
},loadFilter:function(data,_7f7){
return data;
},finder:{getTr:function(_7f8,id,type,_7f9){
type=type||"body";
_7f9=_7f9||0;
var dc=$.data(_7f8,"datagrid").dc;
if(_7f9==0){
var opts=$.data(_7f8,"treegrid").options;
var tr1=opts.finder.getTr(_7f8,id,type,1);
var tr2=opts.finder.getTr(_7f8,id,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+$.data(_7f8,"datagrid").rowIdPrefix+"-"+_7f9+"-"+id);
if(!tr.length){
tr=(_7f9==1?dc.body1:dc.body2).find("tr[node-id=\""+id+"\"]");
}
return tr;
}else{
if(type=="footer"){
return (_7f9==1?dc.footer1:dc.footer2).find("tr[node-id=\""+id+"\"]");
}else{
if(type=="selected"){
return (_7f9==1?dc.body1:dc.body2).find("tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_7f9==1?dc.body1:dc.body2).find("tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_7f9==1?dc.body1:dc.body2).find("tr.datagrid-row-checked");
}else{
if(type=="last"){
return (_7f9==1?dc.body1:dc.body2).find("tr:last[node-id]");
}else{
if(type=="allbody"){
return (_7f9==1?dc.body1:dc.body2).find("tr[node-id]");
}else{
if(type=="allfooter"){
return (_7f9==1?dc.footer1:dc.footer2).find("tr[node-id]");
}
}
}
}
...
return $(_7fa).treegrid("find",id);
},getRows:function(_7fb){
return $(_7fb).treegrid("getChildren");
}},onBeforeLoad:function(row,_7fc){
...
},onClickCell:function(_7fd,row){
},onDblClickCell:function(_7fe,row){
},onContextMenu:function(e,row){
},onBeforeEdit:function(row){
},onAfterEdit:function(row,_7ff){
...
_804.appendTo("body");
var _806=_804.find("input.combo-text");
var _807=_804.find(".combo-arrow");
var _808=opts.hasDownArrow?_807._outerWidth():0;
_804._outerWidth(opts.width)._outerHeight(opts.height);
_806._outerWidth(_804.width()-_808);
_806.css({height:_804.height()+"px",lineHeight:_804.height()+"px"});
_807._outerHeight(_804.height());
_805.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_804.outerWidth()),height:opts.panelHeight});
_804.insertAfter(_801);
};
function init(_809){
$(_809).addClass("combo-f").hide();
var span=$("<span class=\"combo\">"+"<input type=\"text\" class=\"combo-text\" autocomplete=\"off\">"+"<span><span class=\"combo-arrow\"></span></span>"+"<input type=\"hidden\" class=\"combo-value\">"+"</span>").insertAfter(_809);
var _80a=$("<div class=\"combo-panel\"></div>").appendTo("body");
_80a.panel({doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
...
var _80b=$.data(_809,"combo");
if(_80b){
_80b.options.onHidePanel.call(_809);
}
}});
var name=$(_809).attr("name");
if(name){
span.find("input.combo-value").attr("name",name);
$(_809).removeAttr("name").attr("comboName",name);
}
return {combo:span,panel:_80a};
};
function _80c(_80d){
var _80e=$.data(_80d,"combo");
var opts=_80e.options;
var _80f=_80e.combo;
if(opts.hasDownArrow){
_80f.find(".combo-arrow").show();
}else{
_80f.find(".combo-arrow").hide();
}
_810(_80d,opts.disabled);
_811(_80d,opts.readonly);
};
function _812(_813){
var _814=$.data(_813,"combo");
var _815=_814.combo.find("input.combo-text");
_815.validatebox("destroy");
_814.panel.panel("destroy");
_814.combo.remove();
$(_813).remove();
};
function _816(_817){
$(_817).find(".combo-f").each(function(){
...
var _81b=_81a.panel;
var _81c=_81a.combo;
var _81d=_81c.find(".combo-text");
var _81e=_81c.find(".combo-arrow");
...
_81d.bind("click.combo",function(e){
if(!opts.editable){
_81f.call(this);
}else{
var p=$(this).closest("div.combo-panel");
$("div.combo-panel:visible").not(_81b).not(p).panel("close");
}
}).bind("keydown.combo",function(e){
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_819,e);
break;
case 40:
opts.keyHandler.down.call(_819,e);
break;
case 37:
opts.keyHandler.left.call(_819,e);
break;
case 39:
opts.keyHandler.right.call(_819,e);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_819,e);
return false;
case 9:
case 27:
_820(_819);
...
if(opts.editable){
if(_81a.timer){
clearTimeout(_81a.timer);
}
_81a.timer=setTimeout(function(){
var q=_81d.val();
if(_81a.previousValue!=q){
_81a.previousValue=q;
$(_819).combo("showPanel");
opts.keyHandler.query.call(_819,_81d.val(),e);
$(_819).combo("validate");
}
},opts.delay);
}
...
_81e.bind("click.combo",function(){
_81f.call(this);
...
var _823=$.data(_822,"combo").combo;
var _824=$.data(_822,"combo").panel;
_824.panel("move",{left:_823.offset().left,top:_825()});
if(_824.panel("options").closed){
_824.panel("open");
opts.onShowPanel.call(_822);
}
(function(){
if(_824.is(":visible")){
_824.panel("move",{left:_826(),top:_825()});
setTimeout(arguments.callee,200);
}
})();
function _826(){
var left=_823.offset().left;
if(left+_824._outerWidth()>$(window)._outerWidth()+$(document).scrollLeft()){
left=$(window)._outerWidth()+$(document).scrollLeft()-_824._outerWidth();
}
if(left<0){
left=0;
}
...
function _825(){
var top=_823.offset().top+_823._outerHeight();
if(top+_824._outerHeight()>$(window)._outerHeight()+$(document).scrollTop()){
top=_823.offset().top-_824._outerHeight();
}
if(top<$(document).scrollTop()){
top=_823.offset().top+_823._outerHeight();
}
return top;
};
};
function _820(_827){
var _828=$.data(_827,"combo").panel;
_828.panel("close");
};
function _829(_82a){
var opts=$.data(_82a,"combo").options;
var _82b=$(_82a).combo("textbox");
_82b.validatebox($.extend({},opts,{deltaX:(opts.hasDownArrow?opts.deltaX:(opts.deltaX>0?1:-1))}));
};
function _810(_82c,_82d){
var _82e=$.data(_82c,"combo");
var opts=_82e.options;
var _82f=_82e.combo;
if(_82d){
opts.disabled=true;
$(_82c).attr("disabled",true);
_82f.find(".combo-value").attr("disabled",true);
_82f.find(".combo-text").attr("disabled",true);
}else{
opts.disabled=false;
$(_82c).removeAttr("disabled");
_82f.find(".combo-value").removeAttr("disabled");
_82f.find(".combo-text").removeAttr("disabled");
}
};
function _811(_830,mode){
var _831=$.data(_830,"combo");
var opts=_831.options;
opts.readonly=mode==undefined?true:mode;
var _832=opts.readonly?true:(!opts.editable);
_831.combo.find(".combo-text").attr("readonly",_832).css("cursor",_832?"pointer":"");
};
function _833(_834){
var _835=$.data(_834,"combo");
var opts=_835.options;
var _836=_835.combo;
if(opts.multiple){
_836.find("input.combo-value").remove();
}else{
_836.find("input.combo-value").val("");
}
_836.find("input.combo-text").val("");
};
function _837(_838){
var _839=$.data(_838,"combo").combo;
return _839.find("input.combo-text").val();
};
function _83a(_83b,text){
var _83c=$.data(_83b,"combo");
var _83d=_83c.combo.find("input.combo-text");
if(_83d.val()!=text){
_83d.val(text);
$(_83b).combo("validate");
_83c.previousValue=text;
}
};
function _83e(_83f){
var _840=[];
var _841=$.data(_83f,"combo").combo;
_841.find("input.combo-value").each(function(){
_840.push($(this).val());
});
return _840;
};
function _842(_843,_844){
var opts=$.data(_843,"combo").options;
var _845=_83e(_843);
var _846=$.data(_843,"combo").combo;
_846.find("input.combo-value").remove();
var name=$(_843).attr("comboName");
for(var i=0;i<_844.length;i++){
var _847=$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_846);
if(name){
_847.attr("name",name);
}
_847.val(_844[i]);
...
if(aa.length!=_844.length||_844.length!=_845.length){
if(opts.multiple){
opts.onChange.call(_843,_844,_845);
}else{
opts.onChange.call(_843,_844[0],_845[0]);
}
}
};
function _848(_849){
...
function _84e(_84f){
var opts=$.data(_84f,"combo").options;
var fn=opts.onChange;
opts.onChange=function(){
};
if(opts.multiple){
...
_842(_84f,opts.value);
}else{
_84b(_84f,opts.value);
}
}else{
_842(_84f,[]);
}
opts.originalValue=_83e(_84f);
}else{
_84b(_84f,opts.value);
...
$.fn.combo=function(_850,_851){
if(typeof _850=="string"){
var _852=$.fn.combo.methods[_850];
if(_852){
return _852(this,_851);
}else{
return this.each(function(){
var _853=$(this).combo("textbox");
_853.validatebox(_850,_851);
});
}
}
_850=_850||{};
return this.each(function(){
var _854=$.data(this,"combo");
if(_854){
$.extend(_854.options,_850);
}else{
var r=init(this);
_854=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_850),combo:r.combo,panel:r.panel,previousValue:null});
$(this).removeAttr("disabled");
}
_80c(this);
_800(this);
...
var _856=$.data(jq[0],"combo").combo.find("input.combo-text");
return _856.validatebox("isValid");
},clear:function(jq){
return jq.each(function(){
_833(this);
});
...
return _83e(jq[0]);
},setValues:function(jq,_857){
return jq.each(function(){
_842(this,_857);
});
},getValue:function(jq){
return _848(jq[0]);
},setValue:function(jq,_858){
return jq.each(function(){
_84b(this,_858);
});
}};
$.fn.combo.parseOptions=function(_859){
var t=$(_859);
return $.extend({},$.fn.validatebox.parseOptions(_859),$.parser.parseOptions(_859,["width","height","separator",{panelWidth:"number",editable:"boolean",hasDownArrow:"boolean",delay:"number",selectOnNavigation:"boolean"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined),disabled:(t.attr("disabled")?true:undefined),readonly:(t.attr("readonly")?true:undefined),value:(t.val()||undefined)});
};
...
},onChange:function(_85a,_85b){
}});
})(jQuery);
(function($){
var _85c=0;
function _85d(_85e,_85f){
var _860=$.data(_85e,"combobox");
var opts=_860.options;
var data=_860.data;
for(var i=0;i<data.length;i++){
if(data[i][opts.valueField]==_85f){
return i;
}
}
return -1;
...
var _864=$(_862).combo("panel");
var item=opts.finder.getEl(_862,_863);
if(item.length){
if(item.position().top<=0){
var h=_864.scrollTop()+item.position().top;
_864.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_864.height()){
var h=_864.scrollTop()+item.position().top+item.outerHeight()-_864.height();
_864.scrollTop(h);
}
}
}
};
function nav(_865,dir){
var opts=$.data(_865,"combobox").options;
var _866=$(_865).combobox("panel");
var item=_866.children("div.combobox-item-hover");
if(!item.length){
item=_866.children("div.combobox-item-selected");
}
item.removeClass("combobox-item-hover");
var _867="div.combobox-item:visible:not(.combobox-item-disabled):first";
var _868="div.combobox-item:visible:not(.combobox-item-disabled):last";
if(!item.length){
item=_866.children(dir=="next"?_867:_868);
}else{
if(dir=="next"){
item=item.nextAll(_867);
if(!item.length){
item=_866.children(_867);
}
}else{
item=item.prevAll(_867);
if(!item.length){
item=_866.children(_868);
}
}
}
if(item.length){
item.addClass("combobox-item-hover");
var row=opts.finder.getRow(_865,item);
if(row){
_861(_865,row[opts.valueField]);
if(opts.selectOnNavigation){
_869(_865,row[opts.valueField]);
}
}
}
};
function _869(_86a,_86b){
var opts=$.data(_86a,"combobox").options;
var _86c=$(_86a).combo("getValues");
if($.inArray(_86b+"",_86c)==-1){
if(opts.multiple){
_86c.push(_86b);
}else{
_86c=[_86b];
...
_86d(_86a,_86c);
opts.onSelect.call(_86a,opts.finder.getRow(_86a,_86b));
}
};
function _86e(_86f,_870){
var opts=$.data(_86f,"combobox").options;
var _871=$(_86f).combo("getValues");
var _872=$.inArray(_870+"",_871);
if(_872>=0){
_871.splice(_872,1);
_86d(_86f,_871);
opts.onUnselect.call(_86f,opts.finder.getRow(_86f,_870));
}
};
function _86d(_873,_874,_875){
var opts=$.data(_873,"combobox").options;
var _876=$(_873).combo("panel");
_876.find("div.combobox-item-selected").removeClass("combobox-item-selected");
var vv=[],ss=[];
for(var i=0;i<_874.length;i++){
var v=_874[i];
var s=v;
opts.finder.getEl(_873,v).addClass("combobox-item-selected");
var row=opts.finder.getRow(_873,v);
if(row){
...
$(_873).combo("setValues",vv);
if(!_875){
$(_873).combo("setText",ss.join(opts.separator));
}
};
function _877(_878,data,_879){
var _87a=$.data(_878,"combobox");
var opts=_87a.options;
_87a.data=opts.loadFilter.call(_878,data);
_87a.groups=[];
data=_87a.data;
var _87b=$(_878).combobox("getValues");
var dd=[];
var _87c=undefined;
for(var i=0;i<data.length;i++){
var row=data[i];
...
_87c=g;
_87a.groups.push(g);
dd.push("<div id=\""+(_87a.groupIdPrefix+"_"+(_87a.groups.length-1))+"\" class=\"combobox-group\">");
dd.push(opts.groupFormatter?opts.groupFormatter.call(_878,g):g);
dd.push("</div>");
}
}else{
_87c=undefined;
...
dd.push("<div id=\""+(_87a.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
dd.push(opts.formatter?opts.formatter.call(_878,row):s);
dd.push("</div>");
if(row["selected"]&&$.inArray(v,_87b)==-1){
_87b.push(v);
}
}
$(_878).combo("panel").html(dd.join(""));
if(opts.multiple){
_86d(_878,_87b,_879);
}else{
_86d(_878,_87b.length?[_87b[_87b.length-1]]:[],_879);
}
opts.onLoadSuccess.call(_878,data);
};
function _87d(_87e,url,_87f,_880){
var opts=$.data(_87e,"combobox").options;
if(url){
opts.url=url;
}
_87f=_87f||{};
if(opts.onBeforeLoad.call(_87e,_87f)==false){
return;
}
opts.loader.call(_87e,_87f,function(data){
_877(_87e,data,_880);
},function(){
opts.onLoadError.apply(this,arguments);
});
};
function _881(_882,q){
var _883=$.data(_882,"combobox");
...
if(opts.mode=="remote"){
_87d(_882,null,{q:q},true);
}else{
var _884=$(_882).combo("panel");
_884.find("div.combobox-item,div.combobox-group").hide();
var data=_883.data;
var _885=undefined;
for(var i=0;i<data.length;i++){
var row=data[i];
if(opts.filter.call(_882,q,row)){
var v=row[opts.valueField];
var s=row[opts.textField];
var g=row[opts.groupField];
var item=opts.finder.getEl(_882,v).show();
if(s.toLowerCase()==q.toLowerCase()){
_86d(_882,[v]);
item.addClass("combobox-item-selected");
}
if(opts.groupField&&_885!=g){
$("#"+_883.groupIdPrefix+"_"+$.inArray(g,_883.groups)).show();
_885=g;
}
}
}
...
var _888=t.combobox("panel");
var item=_888.children("div.combobox-item-hover");
if(!item.length){
item=_888.children("div.combobox-item-selected");
}
if(!item.length){
return;
}
var row=opts.finder.getRow(_887,item);
if(!row){
return;
}
var _889=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
t.combobox("unselect",_889);
}else{
t.combobox("select",_889);
}
}else{
t.combobox("select",_889);
...
var vv=[];
var _88a=t.combobox("getValues");
for(var i=0;i<_88a.length;i++){
if(_85d(_887,_88a[i])>=0){
vv.push(_88a[i]);
}
}
...
function _88b(_88c){
var _88d=$.data(_88c,"combobox");
var opts=_88d.options;
_85c++;
_88d.itemIdPrefix="_easyui_combobox_i"+_85c;
_88d.groupIdPrefix="_easyui_combobox_g"+_85c;
$(_88c).addClass("combobox-f");
$(_88c).combo($.extend({},opts,{onShowPanel:function(){
$(_88c).combo("panel").find("div.combobox-item,div.combobox-group").show();
_861(_88c,$(_88c).combobox("getValue"));
opts.onShowPanel.call(_88c);
}}));
$(_88c).combo("panel").unbind().bind("mouseover",function(e){
...
var row=opts.finder.getRow(_88c,item);
if(!row){
return;
}
var _88e=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
_86e(_88c,_88e);
}else{
...
$.fn.combobox=function(_88f,_890){
if(typeof _88f=="string"){
var _891=$.fn.combobox.methods[_88f];
if(_891){
return _891(this,_890);
}else{
return this.combo(_88f,_890);
}
}
_88f=_88f||{};
return this.each(function(){
var _892=$.data(this,"combobox");
if(_892){
$.extend(_892.options,_88f);
_88b(this);
}else{
_892=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_88f),data:[]});
_88b(this);
...
if(_892.options.data){
_877(this,_892.options.data);
}
_87d(this);
});
};
$.fn.combobox.methods={options:function(jq){
var _893=jq.combo("options");
return $.extend($.data(jq[0],"combobox").options,{originalValue:_893.originalValue,disabled:_893.disabled,readonly:_893.readonly});
},getData:function(jq){
return $.data(jq[0],"combobox").data;
},setValues:function(jq,_894){
return jq.each(function(){
_86d(this,_894);
});
},setValue:function(jq,_895){
return jq.each(function(){
_86d(this,[_895]);
});
},clear:function(jq){
return jq.each(function(){
$(this).combo("clear");
var _896=$(this).combo("panel");
_896.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},reset:function(jq){
return jq.each(function(){
...
},select:function(jq,_897){
return jq.each(function(){
_869(this,_897);
});
},unselect:function(jq,_898){
return jq.each(function(){
_86e(this,_898);
});
}};
$.fn.combobox.parseOptions=function(_899){
var t=$(_899);
return $.extend({},$.fn.combo.parseOptions(_899),$.parser.parseOptions(_899,["valueField","textField","groupField","mode","method","url"]));
};
$.fn.combobox.parseData=function(_89a){
var data=[];
var opts=$(_89a).combobox("options");
$(_89a).children().each(function(){
if(this.tagName.toLowerCase()=="optgroup"){
var _89b=$(this).attr("label");
...
row[opts.groupField]=_89d;
}
data.push(row);
};
};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupField:null,groupFormatter:function(_89e){
return _89e;
...
},loader:function(_89f,_8a0,_8a1){
var opts=$(this).combobox("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_89f,dataType:"json",success:function(data){
_8a0(data);
},error:function(){
_8a1.apply(this,arguments);
}});
},loadFilter:function(data){
return data;
},finder:{getEl:function(_8a2,_8a3){
var _8a4=_85d(_8a2,_8a3);
var id=$.data(_8a2,"combobox").itemIdPrefix+"_"+_8a4;
return $("#"+id);
},getRow:function(_8a5,p){
var _8a6=$.data(_8a5,"combobox");
var _8a7=(p instanceof jQuery)?p.attr("id").substr(_8a6.itemIdPrefix.length+1):_85d(_8a5,p);
return _8a6.data[parseInt(_8a7)];
}},onBeforeLoad:function(_8a8){
},onLoadSuccess:function(){
},onLoadError:function(){
},onSelect:function(_8a9){
},onUnselect:function(_8aa){
}});
})(jQuery);
(function($){
function _8ab(_8ac){
var _8ad=$.data(_8ac,"combotree");
var opts=_8ad.options;
var tree=_8ad.tree;
$(_8ac).addClass("combotree-f");
$(_8ac).combo(opts);
var _8ae=$(_8ac).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_8ae);
$.data(_8ac,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _8af=$(_8ac).combotree("getValues");
if(opts.multiple){
...
var _8b1=$(this).tree("options");
var _8b2=_8b1.onCheck;
var _8b3=_8b1.onSelect;
_8b1.onCheck=_8b1.onSelect=function(){
};
$(_8ac).combotree("setValues",_8af);
_8b1.onCheck=_8b2;
_8b1.onSelect=_8b3;
...
$(_8ac).combo("hidePanel");
}
_8b5(_8ac);
opts.onClick.call(this,node);
},onCheck:function(node,_8b4){
_8b5(_8ac);
opts.onCheck.call(this,node,_8b4);
}}));
};
function _8b5(_8b6){
var _8b7=$.data(_8b6,"combotree");
var opts=_8b7.options;
var tree=_8b7.tree;
var vv=[],ss=[];
if(opts.multiple){
var _8b8=tree.tree("getChecked");
...
$(_8b6).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
function _8b9(_8ba,_8bb){
var opts=$.data(_8ba,"combotree").options;
var tree=$.data(_8ba,"combotree").tree;
...
$(_8ba).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
$.fn.combotree=function(_8bc,_8bd){
if(typeof _8bc=="string"){
var _8be=$.fn.combotree.methods[_8bc];
if(_8be){
return _8be(this,_8bd);
}else{
return this.combo(_8bc,_8bd);
}
}
_8bc=_8bc||{};
return this.each(function(){
var _8bf=$.data(this,"combotree");
if(_8bf){
$.extend(_8bf.options,_8bc);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_8bc)});
}
_8ab(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _8c0=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{originalValue:_8c0.originalValue,disabled:_8c0.disabled,readonly:_8c0.readonly});
},tree:function(jq){
...
},setValues:function(jq,_8c1){
return jq.each(function(){
_8b9(this,_8c1);
});
},setValue:function(jq,_8c2){
return jq.each(function(){
_8b9(this,[_8c2]);
});
},clear:function(jq){
...
$.fn.combotree.parseOptions=function(_8c3){
return $.extend({},$.fn.combo.parseOptions(_8c3),$.fn.tree.parseOptions(_8c3));
};
...
var grid=_8c6.grid;
$(_8c5).addClass("combogrid-f").combo(opts);
var _8c7=$(_8c5).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_8c7);
_8c6.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,fit:true,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _8c8=$(_8c5).combo("getValues");
var _8c9=opts.onSelect;
opts.onSelect=function(){
};
_8d3(_8c5,_8c8,_8c6.remainText);
opts.onSelect=_8c9;
opts.onLoadSuccess.apply(_8c5,arguments);
},onClickRow:_8ca,onSelect:function(_8cb,row){
_8cc();
opts.onSelect.call(this,_8cb,row);
},onUnselect:function(_8cd,row){
_8cc();
opts.onUnselect.call(this,_8cd,row);
},onSelectAll:function(rows){
_8cc();
...
function _8ca(_8ce,row){
_8c6.remainText=false;
_8cc();
if(!opts.multiple){
$(_8c5).combo("hidePanel");
}
opts.onClickRow.call(this,_8ce,row);
};
function _8cc(){
...
if(!opts.multiple){
$(_8c5).combo("setValues",(vv.length?vv:[""]));
}else{
$(_8c5).combo("setValues",vv);
}
if(!_8c6.remainText){
$(_8c5).combo("setText",ss.join(opts.separator));
}
};
};
function nav(_8cf,dir){
var _8d0=$.data(_8cf,"combogrid");
var opts=_8d0.options;
var grid=_8d0.grid;
var _8d1=grid.datagrid("getRows").length;
if(!_8d1){
return;
}
...
var _8d2;
if(!tr.length){
_8d2=(dir=="next"?0:_8d1-1);
}else{
var _8d2=parseInt(tr.attr("datagrid-row-index"));
_8d2+=(dir=="next"?1:-1);
if(_8d2<0){
_8d2=_8d1-1;
}
...
grid.datagrid("highlightRow",_8d2);
if(opts.selectOnNavigation){
_8d0.remainText=false;
grid.datagrid("selectRow",_8d2);
}
};
function _8d3(_8d4,_8d5,_8d6){
var _8d7=$.data(_8d4,"combogrid");
var opts=_8d7.options;
var grid=_8d7.grid;
var rows=grid.datagrid("getRows");
var ss=[];
var _8d8=$(_8d4).combo("getValues");
var _8d9=$(_8d4).combo("options");
var _8da=_8d9.onChange;
_8d9.onChange=function(){
};
grid.datagrid("clearSelections");
for(var i=0;i<_8d5.length;i++){
var _8db=grid.datagrid("getRowIndex",_8d5[i]);
if(_8db>=0){
grid.datagrid("selectRow",_8db);
ss.push(rows[_8db][opts.textField]);
}else{
ss.push(_8d5[i]);
}
}
$(_8d4).combo("setValues",_8d8);
_8d9.onChange=_8da;
$(_8d4).combo("setValues",_8d5);
if(!_8d6){
var s=ss.join(opts.separator);
if($(_8d4).combo("getText")!=s){
$(_8d4).combo("setText",s);
}
}
};
...
var rows=grid.datagrid("getRows");
for(var i=0;i<rows.length;i++){
if(opts.filter.call(_8dd,q,rows[i])){
grid.datagrid("clearSelections");
...
_8e1.remainText=false;
var _8e2=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_8e2);
}else{
grid.datagrid("selectRow",_8e2);
}
}else{
grid.datagrid("selectRow",_8e2);
$(_8e0).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_8e3,_8e4){
if(typeof _8e3=="string"){
var _8e5=$.fn.combogrid.methods[_8e3];
if(_8e5){
...
_8e3=_8e3||{};
return this.each(function(){
var _8e6=$.data(this,"combogrid");
if(_8e6){
$.extend(_8e6.options,_8e3);
}else{
_8e6=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_8e3)});
}
_8c4(this);
});
};
...
return $.extend($.data(jq[0],"combogrid").options,{originalValue:_8e7.originalValue,disabled:_8e7.disabled,readonly:_8e7.readonly});
},grid:function(jq){
...
$.fn.combogrid.parseOptions=function(_8ea){
var t=$(_8ea);
return $.extend({},$.fn.combo.parseOptions(_8ea),$.fn.datagrid.parseOptions(_8ea),$.parser.parseOptions(_8ea,["idField","textField","mode"]));
};
...
$(_8ec).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_8ee();
_8f6(_8ec,$(_8ec).datebox("getText"));
opts.onShowPanel.call(_8ec);
}}));
$(_8ec).combo("textbox").parent().addClass("datebox");
if(!_8ed.calendar){
_8ef();
}
function _8ef(){
var _8f0=$(_8ec).combo("panel").css("overflow","hidden");
var cc=$("<div class=\"datebox-calendar-inner\"></div>").appendTo(_8f0);
if(opts.sharedCalendar){
_8ed.calendar=$(opts.sharedCalendar).appendTo(cc);
if(!_8ed.calendar.hasClass("calendar")){
_8ed.calendar.calendar();
}
}else{
_8ed.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_8ed.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var opts=$(this.target).datebox("options");
_8f6(this.target,opts.formatter(date));
$(this.target).combo("hidePanel");
opts.onSelect.call(_8ec,date);
}});
_8f6(_8ec,opts.value);
var _8f1=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_8f0);
var tr=_8f1.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a href=\"javascript:void(0)\"></a>").html($.isFunction(btn.text)?btn.text(_8ec):btn.text).appendTo(td);
t.bind("click",{target:_8ec,handler:btn.handler},function(e){
...
function _8ee(){
var _8f2=$(_8ec).combo("panel");
var cc=_8f2.children("div.datebox-calendar-inner");
_8f2.children()._outerWidth(_8f2.width());
_8ed.calendar.appendTo(cc);
_8ed.calendar[0].target=_8ec;
if(opts.panelHeight!="auto"){
var _8f3=_8f2.height();
_8f2.children().not(cc).each(function(){
_8f3-=$(this).outerHeight();
});
cc._outerHeight(_8f3);
}
_8ed.calendar.calendar("resize");
};
};
function _8f4(_8f5,q){
_8f6(_8f5,q);
};
function _8f7(_8f8){
var _8f9=$.data(_8f8,"datebox");
var opts=_8f9.options;
var _8fa=opts.formatter(_8f9.calendar.calendar("options").current);
_8f6(_8f8,_8fa);
$(_8f8).combo("hidePanel");
};
function _8f6(_8fb,_8fc){
var _8fd=$.data(_8fb,"datebox");
var opts=_8fd.options;
$(_8fb).combo("setValue",_8fc).combo("setText",_8fc);
_8fd.calendar.calendar("moveTo",opts.parser(_8fc));
};
$.fn.datebox=function(_8fe,_8ff){
if(typeof _8fe=="string"){
var _900=$.fn.datebox.methods[_8fe];
if(_900){
...
_8fe=_8fe||{};
return this.each(function(){
var _901=$.data(this,"datebox");
if(_901){
$.extend(_901.options,_8fe);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_8fe)});
}
_8eb(this);
});
};
...
return $.extend($.data(jq[0],"datebox").options,{originalValue:_902.originalValue,disabled:_902.disabled,readonly:_902.readonly});
},calendar:function(jq){
return $.data(jq[0],"datebox").calendar;
},setValue:function(jq,_903){
return jq.each(function(){
_8f6(this,_903);
});
},reset:function(jq){
...
$.fn.datebox.parseOptions=function(_904){
return $.extend({},$.fn.combo.parseOptions(_904),$.parser.parseOptions(_904,["sharedCalendar"]));
};
...
_8f4(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_905){
return $(_905).datebox("options").currentText;
},handler:function(_906){
$(_906).datebox("calendar").calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
_8f7(_906);
}},{text:function(_907){
return $(_907).datebox("options").closeText;
},handler:function(_908){
...
(function($){
function _909(_90a){
var _90b=$.data(_90a,"datetimebox");
var opts=_90b.options;
$(_90a).datebox($.extend({},opts,{onShowPanel:function(){
var _90c=$(_90a).datetimebox("getValue");
_90e(_90a,_90c,true);
opts.onShowPanel.call(_90a);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_90a).removeClass("datebox-f").addClass("datetimebox-f");
$(_90a).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(_90a,date);
}});
var _90d=$(_90a).datebox("panel");
if(!_90b.spinner){
var p=$("<div style=\"padding:2px\"><input style=\"width:80px\"></div>").insertAfter(_90d.children("div.datebox-calendar-inner"));
_90b.spinner=p.children("input");
}
_90b.spinner.timespinner({showSeconds:opts.showSeconds,separator:opts.timeSeparator}).unbind(".datetimebox").bind("mousedown.datetimebox",function(e){
e.stopPropagation();
});
_90e(_90a,opts.value);
};
function _90f(_910){
var c=$(_910).datetimebox("calendar");
var t=$(_910).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _911(_912,q){
_90e(_912,q,true);
};
function _913(_914){
var opts=$.data(_914,"datetimebox").options;
var date=_90f(_914);
_90e(_914,opts.formatter.call(_914,date));
$(_914).combo("hidePanel");
};
function _90e(_915,_916,_917){
var opts=$.data(_915,"datetimebox").options;
$(_915).combo("setValue",_916);
if(!_917){
if(_916){
var date=opts.parser.call(_915,_916);
$(_915).combo("setValue",opts.formatter.call(_915,date));
$(_915).combo("setText",opts.formatter.call(_915,date));
}else{
$(_915).combo("setText",_916);
}
}
var date=opts.parser.call(_915,_916);
$(_915).datetimebox("calendar").calendar("moveTo",date);
$(_915).datetimebox("spinner").timespinner("setValue",_918(date));
function _918(date){
function _919(_91a){
return (_91a<10?"0":"")+_91a;
};
var tt=[_919(date.getHours()),_919(date.getMinutes())];
if(opts.showSeconds){
tt.push(_919(date.getSeconds()));
}
return tt.join($(_915).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_91b,_91c){
if(typeof _91b=="string"){
var _91d=$.fn.datetimebox.methods[_91b];
if(_91d){
return _91d(this,_91c);
}else{
return this.datebox(_91b,_91c);
}
}
_91b=_91b||{};
return this.each(function(){
var _91e=$.data(this,"datetimebox");
if(_91e){
$.extend(_91e.options,_91b);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_91b)});
}
_909(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _91f=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_91f.originalValue,disabled:_91f.disabled,readonly:_91f.readonly});
},spinner:function(jq){
...
$.fn.datetimebox.parseOptions=function(_921){
var t=$(_921);
return $.extend({},$.fn.datebox.parseOptions(_921),$.parser.parseOptions(_921,["timeSeparator",{showSeconds:"boolean"}]));
};
...
_911(this,q);
}},buttons:[{text:function(_922){
return $(_922).datetimebox("options").currentText;
},handler:function(_923){
$(_923).datetimebox("calendar").calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
_913(_923);
}},{text:function(_924){
return $(_924).datetimebox("options").okText;
},handler:function(_925){
_913(_925);
}},{text:function(_926){
return $(_926).datetimebox("options").closeText;
},handler:function(_927){
$(this).closest("div.combo-panel").panel("close");
}}],formatter:function(date){
var h=date.getHours();
...
var _92a=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_928(h)+_92a+_928(M);
...
var _92b=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_92b);
var hour=parseInt(tt[0],10)||0;
var _92c=parseInt(tt[1],10)||0;
var _92d=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_92c,_92d);
}});
})(jQuery);
(function($){
function init(_92e){
var _92f=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_92e);
var t=$(_92e);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_92f.find("input.slider-value").attr("name",name);
...
if(_932){
if(_932.width){
opts.width=_932.width;
}
if(_932.height){
opts.height=_932.height;
}
}
if(opts.mode=="h"){
_934.css("height","");
_934.children("div").css("height","");
if(!isNaN(opts.width)){
_934.width(opts.width);
}
}else{
_934.css("width","");
_934.children("div").css("width","");
if(!isNaN(opts.height)){
_934.height(opts.height);
_934.find("div.slider-rule").height(opts.height);
_934.find("div.slider-rulelabel").height(opts.height);
_934.find("div.slider-inner")._outerHeight(opts.height);
}
}
_935(_931);
};
function _936(_937){
var _938=$.data(_937,"slider");
...
_93a(aa);
function _93a(aa){
var rule=_939.find("div.slider-rule");
var _93b=_939.find("div.slider-rulelabel");
rule.empty();
_93b.empty();
for(var i=0;i<aa.length;i++){
var _93c=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_93c);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_93b);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_93c,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_93c,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _93d(_93e){
var _93f=$.data(_93e,"slider");
var opts=_93f.options;
var _940=_93f.slider;
_940.removeClass("slider-h slider-v slider-disabled");
_940.addClass(opts.mode=="h"?"slider-h":"slider-v");
_940.addClass(opts.disabled?"slider-disabled":"");
_940.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
var _942=_954(_93e,left);
_943(_942);
return false;
}
},onBeforeDrag:function(){
_93f.isDragging=true;
},onStartDrag:function(){
opts.onSlideStart.call(_93e,opts.value);
},onStopDrag:function(e){
var _944=_954(_93e,(opts.mode=="h"?e.data.left:e.data.top));
_943(_944);
opts.onSlideEnd.call(_93e,opts.value);
opts.onComplete.call(_93e,opts.value);
_93f.isDragging=false;
}});
_940.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_93f.isDragging){
return;
}
var pos=$(this).offset();
var _945=_954(_93e,(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top)));
_943(_945);
opts.onComplete.call(_93e,opts.value);
});
function _943(_946){
var s=Math.abs(_946%opts.step);
if(s<opts.step/2){
_946-=s;
}else{
_946=_946-s+opts.step;
}
_947(_93e,_946);
};
};
...
opts.value=_949;
$(_948).val(_949);
_94b.find("input.slider-value").val(_949);
var pos=_94d(_948,_949);
var tip=_94b.find(".slider-tip");
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_948,opts.value));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _94e="left:"+pos+"px;";
_94b.find(".slider-handle").attr("style",_94e);
tip.attr("style",_94e+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _94e="top:"+pos+"px;";
_94b.find(".slider-handle").attr("style",_94e);
tip.attr("style",_94e+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
if(_94c!=_949){
opts.onChange.call(_948,_949,_94c);
}
};
function _935(_94f){
var opts=$.data(_94f,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_947(_94f,opts.value);
opts.onChange=fn;
};
function _94d(_950,_951){
var _952=$.data(_950,"slider");
var opts=_952.options;
var _953=_952.slider;
if(opts.mode=="h"){
var pos=(_951-opts.min)/(opts.max-opts.min)*_953.width();
if(opts.reversed){
pos=_953.width()-pos;
}
}else{
var pos=_953.height()-(_951-opts.min)/(opts.max-opts.min)*_953.height();
if(opts.reversed){
pos=_953.height()-pos;
}
}
...
function _954(_955,pos){
var _956=$.data(_955,"slider");
var opts=_956.options;
var _957=_956.slider;
if(opts.mode=="h"){
var _958=opts.min+(opts.max-opts.min)*(pos/_957.width());
}else{
var _958=opts.min+(opts.max-opts.min)*((_957.height()-pos)/_957.height());
}
return opts.reversed?opts.max-_958.toFixed(0):_958.toFixed(0);
};
$.fn.slider=function(_959,_95a){
if(typeof _959=="string"){
return $.fn.slider.methods[_959](this,_95a);
}
_959=_959||{};
return this.each(function(){
var _95b=$.data(this,"slider");
if(_95b){
$.extend(_95b.options,_959);
}else{
_95b=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_959),slider:init(this)});
$(this).removeAttr("disabled");
}
...
},resize:function(jq,_95c){
return jq.each(function(){
_930(this,_95c);
});
},getValue:function(jq){
return jq.slider("options").value;
},setValue:function(jq,_95d){
return jq.each(function(){
_947(this,_95d);
});
},clear:function(jq){
...
$.fn.slider.parseOptions=function(_95e){
var t=$(_95e);
return $.extend({},$.parser.parseOptions(_95e,["width","height","mode",{reversed:"boolean",showTip:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_95f){
return _95f;
},onChange:function(_960,_961){
},onSlideStart:function(_962){
},onSlideEnd:function(_963){
},onComplete:function(_964){
}};
})(jQuery);
